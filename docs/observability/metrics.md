...
| kubevirt_vmi_migration_last_downtime_duration_seconds | Metric | Gauge | Time, in seconds, the guest was paused during the cut-over of its last successful live migration, reported by the source node. |
