...
Details of Virtual Machine (VM) vNIC interfaces, such as vNIC name, binding type, network name, and binding plugin in use for each vNIC defined in the VM's configuration. Type: Gauge.
...
Details of VirtualMachineInstance (VMI) vNIC interfaces, such as vNIC name, binding type, network name, and binding plugin in use for each vNIC of a running instance. Type: Gauge.
