...
| kubevirt_vmi_guest_device_driver_date_seconds | Metric | Gauge | Timestamp of the VirtIO device driver date as reported by the guest agent, in seconds since epoch. |
