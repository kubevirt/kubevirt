...
| kubevirt_vm_resource_limits | Metric | Gauge | Resource limits for a Virtual Machine. Reports memory and CPU limits. |
...
| kubevirt_workqueue_unfinished_work_seconds | Metric | Gauge | How many seconds of work have been in progress and haven't been observed by work_duration. Large values indicate stuck threads. One can deduce the number of stuck threads by observing the rate at which this increases. |
