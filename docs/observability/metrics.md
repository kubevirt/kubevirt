...
| kubevirt_vmi_guest_os_termination_total | Metric | Counter | Total number of observed guest OS termination events, partitioned by VMI and normalized termination reason. |
