...
require (
	...
	kubevirt.io/client-go v0.45.0-rc.0
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.45.0-rc.0
)

// Aligning with https://github.com/kubevirt/containerized-data-importer/blob/release-v1.38.0
replace (
