...
require (
	...
	github.com/operator-framework/operator-registry v1.0.4 // indirect
	...
	k8s.io/apiserver v0.0.0-20181026151315-13cfe3978170 // indirect
	k8s.io/client-go v11.0.0+incompatible
	k8s.io/code-generator v0.0.0-20181203235156-f8cba74510f3 // indirect
	k8s.io/gengo v0.0.0-20181113154421-fd15ee9cc2f7 // indirect
	k8s.io/kube-aggregator v0.0.0-20190228175259-3e0149950b0e
	k8s.io/kubernetes v1.11.8-beta.0.0.20190124204751-3a10094374f2 // indirect
