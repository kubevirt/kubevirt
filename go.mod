...
require (
	...
	github.com/kubevirt/cluster-network-addons-operator v0.59.0
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.45.0
)

// Aligning with https://github.com/kubevirt/containerized-data-importer/blob/release-v1.39.0
replace (
