...
require (
	...
	kubevirt.io/client-go v0.43.0-rc.1
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.43.0-rc.1
)

// Aligning with https://github.com/kubevirt/containerized-data-importer/blob/release-v1.36.0
replace (
