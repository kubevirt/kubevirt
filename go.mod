...
require (
	...
	kubevirt.io/kubevirt v0.35.0-rc.0
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.35.0-rc.0
)

// Aligning with https://github.com/kubevirt/containerized-data-importer/blob/release-v1.25.0
replace (
