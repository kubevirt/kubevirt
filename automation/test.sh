...
# BLOCK_0 are non-flaky tests
#export KUBEVIRT_E2E_SKIP="${KUBEVIRT_E2E_SKIP}|BLOCK_0"

# Skipping BLOCK_100
#export KUBEVIRT_E2E_SKIP="${KUBEVIRT_E2E_SKIP}|BLOCK_100"

# Skipping BLOCK_101
#export KUBEVIRT_E2E_SKIP="${KUBEVIRT_E2E_SKIP}|BLOCK_101"

# Skipping BLOCK_11
#export KUBEVIRT_E2E_SKIP="${KUBEVIRT_E2E_SKIP}|BLOCK_11"
