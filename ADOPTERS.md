...
| Vendor | Swisscom | 2024 | [link](https://www.swisscom.ch/en/business/enterprise/offer/cloud/cloudnative/container-services.html) | Swisscom uses KubeVirt as a cloud-native infrastrucure platform to enable VM workloads on bare-metal kubernets. On top, we offer a kubernetes as a service, additionally making use of kubevirt-csi to provide a storage solution to the end user clusters. |
