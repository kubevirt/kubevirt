...
#
# This script should be executed through the makefile via `make kwok-perftest`.
...
echo 'KWOK Performance testing'

echo 'Create kubevirt related kwok manifests'
...
if [ -n "$KUBEVIRT_E2E_LABEL_FILTER" ]; then
    ...
    export KUBEVIRT_E2E_LABEL_FILTER="KWOK && sig-performance"
fi
