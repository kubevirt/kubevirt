...
_cluster_instancetypes_path="pkg/virt-operator/resource/generate/components/data/instancetype/common-clusterinstancetypes-bundle.yaml"
_cluster_preferences_path="pkg/virt-operator/resource/generate/components/data/instancetype/common-clusterpreferences-bundle.yaml"
