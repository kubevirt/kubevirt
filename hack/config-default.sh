...
docker_images_container_disks="images/cirros-container-disk-demo images/fedora-liveiso-container-disk-demo images/fedora-cloud-container-disk-demo images/alpine-container-disk-demo images/virtio-container-disk"
