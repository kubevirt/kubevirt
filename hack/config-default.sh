binaries="cmd/virt-controller cmd/virt-launcher cmd/virt-handler cmd/virt-api cmd/virtctl cmd/virt-manifest cmd/fake-qemu-process cmd/virt-handler/network-helper/ cmd/virt-handler/cnitool cmd/virt-handler/cni/main/ipamonly cmd/virt-handler/cni/ipam/noroutes"
