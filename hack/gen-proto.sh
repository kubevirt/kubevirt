...
protoc --proto_path=pkg/hooks/plugins/v1alpha1 --go_out=plugins=grpc,import_path=pluginsv1alpha1:pkg/hooks/plugins/v1alpha1 pkg/hooks/plugins/v1alpha1/api.proto
