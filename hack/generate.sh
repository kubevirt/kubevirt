...
swagger-doc -in ${KUBEVIRT_DIR}/staging/src/kubevirt.io/api/instancetype/v1/types.go
...
client-gen --clientset-name kubevirt \
    ...
    --input core/v1,export/v1alpha1,export/v1beta1,snapshot/v1alpha1,snapshot/v1beta1,instancetype/v1beta1,instancetype/v1,pool/v1alpha1,pool/v1beta1,migrations/v1alpha1,clone/v1alpha1,clone/v1beta1,backup/v1alpha1 \
...
(
    ...
    GOFLAGS= controller-gen crd paths=../api/instancetype/v1/
