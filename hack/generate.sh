...
client-gen --clientset-name versioned \
    ...
    --input export/v1alpha1,snapshot/v1alpha1,instancetype/v1alpha1,instancetype/v1alpha2,pool/v1alpha1,migrations/v1alpha1,clone/v1alpha1,virtualMachineMigrationResourceQuota/v1alpha1 \
    --output-base ${KUBEVIRT_DIR}/staging/src \
