...
bazel build \
    ...
    //cmd/virt-controller:virt-controller-image //cmd/virt-handler:virt-handler-image //cmd/virt-launcher:virt-launcher-image //cmd/libguestfs:libguestfs-tools-image //tests:conformance_image //cmd/dedicated-cpu-container:dedicated-cpu-container-image
