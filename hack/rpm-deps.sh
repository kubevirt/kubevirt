...
LIBVIRT_VERSION=${LIBVIRT_VERSION:-0:11.10.0-2.el9}
QEMU_VERSION=${QEMU_VERSION:-17:10.1.0-10.el9}
SEABIOS_VERSION=${SEABIOS_VERSION:-0:1.16.3-5.el9}
EDK2_VERSION=${EDK2_VERSION:-0:20241117-8.el9}
LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION:-1:1.54.0-11.el9}
GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION:-0:1.52.2-6.el9}
PASST_VERSION=${PASST_VERSION:-0:0^20251210.gd04c480-2.el9}
VIRTIOFSD_VERSION=${VIRTIOFSD_VERSION:-0:1.13.3-1.el9}
