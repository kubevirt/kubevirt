...
func (app *virtHandlerApp) Run() {
	...
	migrationProxy := migrationproxy.NewMigrationProxyManager(app.migrationServerTLSConfig, app.migrationClientTLSConfig, app.migrationClientTLSConfig, app.clusterConfig)
