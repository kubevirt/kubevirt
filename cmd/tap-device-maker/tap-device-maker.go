...
func main() {
	tapName := flag.String("tapName", "tap0", "override the name of the tap device.")
	isMultiqueue := flag.Bool("isMultiqueue", false, "override the multi-queue flag of the tap device. Defaults to 'false'")
