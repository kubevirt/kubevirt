...
func main() {
	...
	pciPortNum := pflag.Int("pci-port-num", 20, "Add how much pcie-root-port controllers used for q35 machine hotplug virtio-blk disk")
	...
	options := cmdserver.NewServerOptions(*allowEmulation, *pciPortNum)
