	...
	Context("generate domain spec interface", func() {
		...
		It("should honor a custom socket file name", func() {
			...
			expectedDomainIface := libvirtxml.DomainInterface{
				Alias:  &libvirtxml.DomainAlias{Name: userAliasPrefix + "default"},
		...
		It("should honor a custom socket mode", func() {
			...
			expectedDomainIface := libvirtxml.DomainInterface{
				Alias:  &libvirtxml.DomainAlias{Name: userAliasPrefix + "default"},
				Source: vhostUserSource(testSocketPath, "server"),
				Model:  &libvirtxml.DomainInterfaceModel{Type: "virtio-non-transitional"},
			}
		...
		It("should not override other interfaces", func() {
			...
			existingIface := libvirtxml.DomainInterface{Alias: &libvirtxml.DomainAlias{Name: userAliasPrefix + "existing-iface"}}
