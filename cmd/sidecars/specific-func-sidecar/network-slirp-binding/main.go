...
import (
	...
	"kubevirt.io/kubevirt/cmd/sidecars/specific-func-sidecar/network-slirp-binding/dns"
	srv "kubevirt.io/kubevirt/cmd/sidecars/specific-func-sidecar/network-slirp-binding/server"
)
