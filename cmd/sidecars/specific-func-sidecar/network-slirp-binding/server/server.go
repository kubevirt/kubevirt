...
import (
	...
	"kubevirt.io/kubevirt/cmd/sidecars/specific-func-sidecar/network-slirp-binding/callback"
	"kubevirt.io/kubevirt/cmd/sidecars/specific-func-sidecar/network-slirp-binding/domain"
)
