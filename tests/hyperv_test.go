...
var _ = Describe("[sig-compute] Hyper-V enlightenments", decorators.SigCompute, func() {
	...
	Context("VMI with HyperV re-enlightenment enabled", func() {
		...
		DescribeTable(" the vmi with EVMCS HyperV feature should have correct HyperV and cpu features auto filled", Serial, decorators.WgS390x, func(featureState *v1.FeatureState) {
	...
	Context("VMI with HyperV passthrough", func() {
		It("should be usable and non-migratable", decorators.WgS390x, func() {
