...
var _ = Describe("Networking", func() {
	...
	Context("VirtualMachineInstance with cni ptp plugin interface", func() {
		...
		It("should create a virtual machine with one interface", func() {
			...
			detachedVMI.Spec.Domain.Devices.Interfaces = []v1.Interface{{Name: "ptp-conf", InterfaceBindingMethod: v1.InterfaceBindingMethod{Bridge: &v1.InterfaceBridge{}}}}
			detachedVMI.Spec.Networks = []v1.Network{{Name: "ptp-conf", NetworkSource: v1.NetworkSource{Multus: &v1.MultusNetwork{}}}}
