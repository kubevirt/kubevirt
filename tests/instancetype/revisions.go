...
var _ = FDescribe("[crit:medium][vendor:cnv-qe@redhat.com][level:component][sig-compute] Instancetype and Preference Revisions", Serial, decorators.SigCompute, decorators.SigComputeInstancetype, func() {
