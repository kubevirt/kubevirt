...
var _ = Describe("[crit:medium][vendor:cnv-qe@redhat.com][level:component][sig-compute] Instancetype and Preference Revisions", decorators.SigCompute, decorators.SigComputeInstancetype, decorators.WgS390x, func() {
