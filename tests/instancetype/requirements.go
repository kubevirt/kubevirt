...
var _ = FDescribe("[crit:medium][vendor:cnv-qe@redhat.com][level:component][sig-compute] Preference requirements", Serial, decorators.SigCompute, decorators.SigComputeInstancetype, func() {
	var (
