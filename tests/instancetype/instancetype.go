...
var _ = FDescribe("[crit:medium][vendor:cnv-qe@redhat.com][level:component][sig-compute] Instancetype and Preferences application", Serial, decorators.SigCompute, decorators.SigComputeInstancetype, func() {
