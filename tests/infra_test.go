...
var _ = Describe("[Serial][sig-compute]Infrastructure", func() {
	...
	Describe("tls configuration", func() {
		...
		It("should result only connections with the correct client-side tls configurations are accepted by the components", func() {
			labelSelectorList := []string{"kubevirt.io=virt-api", "kubevirt.io=virt-handler"}
