...
var VirtLauncherErrorAllowlist = []*regexp.Regexp{
	// Guest agent errors
	regexp.MustCompile(`"level":"error","msg":"Fetching guest info failed:.*(The command guest-get-load has not been found|virError\(Code=.*, Domain=.*, Message='Requested operation is not valid: domain is not running'\))`),
	regexp.MustCompile(`"level":"error","msg":"Guest agent is not responding: (QEMU guest agent is not connected|Guest agent disappeared while executing command)","pos":"qemu(DomainAgentAvailable|AgentCommandFull)`),
	...
	regexp.MustCompile(`"level":"error","msg":"Connection to libvirt lost\.",".*"reason":".*Connection reset by peer`),
	...
	regexp.MustCompile(`"level":"error","msg":"Could not fetch the Domain\.",".*"reason":".*(Connection reset by peer|Failed to connect socket.*Connection refused|virError\(Code=.*, Domain=.*, Message='internal error: client socket is closed'\))`),
	...
	regexp.MustCompile(`"level":"error","msg":"(migration failed with error|Live migration failed\.|Received a live migration error\. Will check the latest migration status\.).*virError\(Code=.*, Domain=.*, Message='internal error: client socket is closed'\)`),
	...
	regexp.MustCompile(`"level":"error","msg":"internal error: unable to execute QEMU command 'nbd-server-start': Failed to bind socket to.*No such file or directory","pos":"qemuMonitorJSONCheckErrorFull`),
