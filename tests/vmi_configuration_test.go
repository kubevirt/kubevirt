...
var _ = Describe("[sig-compute]Configurations", decorators.SigCompute, func() {
	...
	Describe("[rfe_id:897][crit:medium][arm64][vendor:cnv-qe@redhat.com][level:component]VirtualMachineInstance with CPU pinning", decorators.RequiresTwoWorkerNodesWithCPUManager, func() {
		var nodes *k8sv1.NodeList
