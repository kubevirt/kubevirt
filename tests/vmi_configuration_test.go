...
var _ = Describe("[sig-compute]Configurations", decorators.SigCompute, func() {
	...
	Describe("VirtualMachineInstance definition", func() {
		...
		Context("[rfe_id:140][crit:medium][vendor:cnv-qe@redhat.com][level:component]with hugepages", func() {
			...
			noOption := func() libvmi.Option {
				return func(_ *v1.VirtualMachineInstance) {}
			}
			...
			DescribeTable("should consume hugepages ", func(options ...libvmi.Option) {
				...
				Entry("[Serial][test_id:1671]hugepages-2Mi", decorators.RequiresHugepages2Mi, Serial, libvmi.WithHugepages("2Mi"), libvmi.WithResourceMemory("64Mi"), noOption()),
				Entry("[Serial][test_id:1672]hugepages-1Gi", decorators.RequiresHugepages1Gi, Serial, libvmi.WithHugepages("1Gi"), "1Gi", noOption()),
				Entry("[Serial][test_id:1672]hugepages-2Mi with guest memory set explicitly", decorators.RequiresHugepages2Mi, Serial, libvmi.WithHugepages("2Mi"), libvmi.WithResourceMemory("70Mi"), libvmi.WithGuestMemory("64Mi")),
			)
	...
	Context("Block size configuration set", func() {
		...
		It("[test_id:6965]Should set BlockIO when using custom block sizes", decorators.BlockRWO, decorators.SigStorage, func() {
		...
		It("[test_id:6966]Should set BlockIO when set to match volume block sizes on block devices", decorators.BlockRWO, decorators.SigStorage, func() {
	...
	Describe("[rfe_id:897][crit:medium][arm64][vendor:cnv-qe@redhat.com][level:component]VirtualMachineInstance with CPU pinning", decorators.RequiresTwoWorkerNodesWithCPUManager, decorators.WgS390x, func() {
		var nodes *k8sv1.NodeList
