...
func (n *noopTopologyHinter) TopologyHintsForVMI(_ *virtv1.VirtualMachineInstance) (*virtv1.TopologyHints, topology.TscFrequencyRequirementType, error) { //nolint:lll
...
type noopVsockAllocator struct{}

func (n *noopVsockAllocator) Sync(_ []*virtv1.VirtualMachineInstance)         {}
func (n *noopVsockAllocator) Allocate(_ *virtv1.VirtualMachineInstance) error { return nil }
func (n *noopVsockAllocator) Remove(_ string)                                 {}
