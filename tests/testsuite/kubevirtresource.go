...
func GetVMGuestByArchitecture(arch string,
	vmi *v1.VirtualMachineInstance, loginToVMI console.LoginToFunction, opts ...libvmi.Option) (*v1.VirtualMachineInstance, console.LoginToFunction) {
