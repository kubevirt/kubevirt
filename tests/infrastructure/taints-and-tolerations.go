...
var _ = Describe(SIGSerial("[rfe_id:4126][crit:medium][vendor:cnv-qe@redhat.com][level:component]Taints and toleration", decorators.RequiresDedicatedWorkerNodes, func() { //nolint:lll
