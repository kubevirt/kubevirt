...
var _ = SIGDescribe("Declarative Hotplug", Serial, func() {
	...
	BeforeEach(func() {
		...
		config.EnableFeatureGate(featuregate.DeclarativeHotplugVolumeGate)
	})
	...
	createVM := func(options ...libvmi.Option) *v1.VirtualMachine {
		vm := libvmi.NewVirtualMachine(
			...
			libvmi.WithUpdateVolumesStrategy(v1.UpdateVolumesStrategyHotplug))
