...
var _ = SIGDescribe("[SKIP][Serial]ImageUpload", func() {
	...
	Context("Upload an image and start a VMI with PVC on rook-ceph", func() {
		DescribeTable("[owner:@sig-storage][test_id:4621] Should succeed", func(resource, targetName string, validateFunc func(string, string), deleteFunc func(string), startVM bool) {
