...
var _ = Describe("Backup with migration", func() {
	...
	DescribeTable("should preserve checkpoints and perform incremental backup after live migration",
		...
		Entry("RWX backend storage", decorators.SigComputeMigrations, decorators.RequiresTwoSchedulableNodes, decorators.RequiresRWXFsVMStateStorageClass,
		...
		PEntry("RWO backend storage", decorators.SigStorage, decorators.RequiresTwoSchedulableNodes, decorators.RequiresRWOFsVMStateStorageClass, decorators.RequiresRWXBlock,
