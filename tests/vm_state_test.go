...
var _ = Describe("[sig-compute]VM state", func() {
	...
	Context("with persistent TPM VM option enabled", func() {
		...
		DescribeTable("should persist VM state of", decorators.RequiresTwoSchedulableNodes, func(withTPM, withEFI, shouldBeRWX bool, ops ...string) {
			...
			Entry("[test_id:10818]TPM across migration and restart", decorators.SigComputeMigrations, decorators.RequiresRWXFs, tpm, !efi, rwx, "migrate", "restart"),
			Entry("[test_id:10819]TPM across restart and migration", decorators.SigComputeMigrations, decorators.RequiresRWXFs, tpm, !efi, rwx, "restart", "migrate"),
			Entry("[test_id:10820]EFI across migration and restart", decorators.SigComputeMigrations, decorators.RequiresRWXFs, !tpm, efi, rwx, "migrate", "restart"),
			Entry("[test_id:10821]TPM+EFI across migration and restart", decorators.SigComputeMigrations, decorators.RequiresRWXFs, tpm, efi, rwx, "migrate", "restart"),
			...
			Entry("TPM across migration and restart", decorators.SigCompute, decorators.RequiresRWOFs, decorators.NoFlakeCheck, tpm, !efi, rwo, "migrate", "restart"),
			Entry("TPM across restart and migration", decorators.SigCompute, decorators.RequiresRWOFs, decorators.NoFlakeCheck, tpm, !efi, rwo, "restart", "migrate"),
			Entry("EFI across migration and restart", decorators.SigCompute, decorators.RequiresRWOFs, decorators.NoFlakeCheck, !tpm, efi, rwo, "migrate", "restart"),
			Entry("TPM+EFI across migration and restart", decorators.SigCompute, decorators.RequiresRWOFs, decorators.NoFlakeCheck, tpm, efi, rwo, "migrate", "restart"),
		)
