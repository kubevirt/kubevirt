...
func WithDefaultInstancetype(name, kind string) dvOption {
	return func(dv *v1beta1.DataVolume) {
		if dv.Labels == nil {
...
func WithDefaultPreference(name, kind string) dvOption {
	return func(dv *v1beta1.DataVolume) {
		if dv.Labels == nil {
			dv.Labels = map[string]string{}
		}
...
func WithDataVolumeSourceRef(name, namespace, kind string) dvOption {
	return func(dv *v1beta1.DataVolume) {
