...
var _ = Describe("[sig-compute]Guest console log", decorators.SigCompute, decorators.WgS390x, func() {
	...
	Describe("[level:component] Guest console log container", func() {
		...
		Context("fetch logs", func() {
			...
			It("[QUARANTINE] it should fetch logs for a running VM with logs API", decorators.Quarantine, decorators.WgS390x, func() {
				vmi = libvmops.RunVMIAndExpectLaunch(alpineVmi, alpineStartupTimeout)
			...
			It("it should rotate the internal log files", decorators.Periodic, decorators.WgS390x, func() {
				vmi = libvmops.RunVMIAndExpectLaunch(alpineVmi, alpineStartupTimeout)
			...
			It("[QUARANTINE] it should not skip any log line even trying to flood the serial console for QOSGuaranteed VMs", decorators.Quarantine, decorators.Periodic, decorators.WgS390x, func() {
