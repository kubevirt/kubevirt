...
var _ = FDescribe("[sig-compute]Memory Hotplug", decorators.WgArm64, decorators.SigCompute, decorators.SigComputeMigrations, decorators.RequiresTwoSchedulableNodes, decorators.VMLiveUpdateRolloutStrategy, Serial, func() {
	var (
