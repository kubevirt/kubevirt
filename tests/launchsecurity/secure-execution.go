...
var _ = Describe("[sig-compute]IBM Secure Execution", decorators.SecureExecution, decorators.SigCompute, decorators.RequiresS390X, func() {
	...
	Context("Ensure cluster can run Secure Execution VMs", func() {
		...
		It("Should launch a Secure Execution VM", func() {
			By("Checking that the pod is scheduled on Secure Execution enabled nodes")
