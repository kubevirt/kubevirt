...
import (
	...
	agggregatorclient "k8s.io/kube-aggregator/pkg/client/clientset_generated/clientset"
...
var _ = Describe("[sig-operator]Operator", Serial, decorators.SigOperator, func() {
	var (
		...
		aggregatorClient       *agggregatorclient.Clientset
	...
	BeforeEach(func() {
		...
		aggregatorClient = agggregatorclient.NewForConfigOrDie(config)
