...
var _ = Describe(SIG("VM Live Migration", decorators.RequiresTwoSchedulableNodes, func() {
	...
	Describe("Starting a VirtualMachineInstance ", func() {
		...
		Context("with a Alpine disk", func() {
			...
			It("should successfully migrate a VM with a container disk after ejecting a CD-ROM volume", decorators.StorageReq, decorators.RequiresRWXBlock, func() {
				...
				cdromDV := libdv.NewDataVolume(
					...
					libdv.WithStorage(
						libdv.StorageWithStorageClass(libstorage.Config.StorageRWXBlock),
