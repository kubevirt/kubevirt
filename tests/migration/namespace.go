...
var _ = Describe(SIG("Live Migration across namespaces", decorators.RequiresDecentralizedLiveMigration, func() {
	...
	Context("with migration policy", func() {
		...
		BeforeEach(func() {
			...
			policy = CreateMigrationPolicy(virtClient, PreparePolicyAndVMIWithBandwidthLimitation(sourceVMI, resource.MustParse("1Ki")))
		...
		AfterEach(func() {
			...
			DeleteMigrationPolicy(virtClient, policy)
		})
