...
var NetworkBindingPlugin string
...
func init() {
	...
	flag.StringVar(&NetworkBindingPlugin, "network-binding-plugin", "", "Name of a pre-registered network binding plugin to use instead of masquerade in conformance tests")
}
