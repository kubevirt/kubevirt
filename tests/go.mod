...
require (
	github.com/kubevirt/cluster-network-addons-operator v0.88.0
...
replace (
	...
	github.com/kubevirt/cluster-network-addons-operator => github.com/kubevirt/cluster-network-addons-operator v0.88.0
	github.com/kubevirt/cluster-network-addons-operator/pkg/apis => github.com/kubevirt/cluster-network-addons-operator/pkg/apis v0.88.0
	...
	kubevirt.io/containerized-data-importer-api => kubevirt.io/containerized-data-importer-api v1.57.0-rc1
)
