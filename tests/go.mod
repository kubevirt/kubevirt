...
require (
	github.com/kubevirt/cluster-network-addons-operator v0.80.0
...
replace (
	...
	github.com/kubevirt/cluster-network-addons-operator => github.com/kubevirt/cluster-network-addons-operator v0.80.0
