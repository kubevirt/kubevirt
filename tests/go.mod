...
require (
	github.com/kubevirt/cluster-network-addons-operator v0.85.0
	...
	kubevirt.io/containerized-data-importer-api v1.56.0-rc0
...
replace (
	...
	github.com/kubevirt/cluster-network-addons-operator => github.com/kubevirt/cluster-network-addons-operator v0.85.0
	github.com/kubevirt/cluster-network-addons-operator/pkg/apis => github.com/kubevirt/cluster-network-addons-operator/pkg/apis v0.85.0
	...
	kubevirt.io/containerized-data-importer-api => kubevirt.io/containerized-data-importer-api v1.56.0-rc0
)
