...
// NewForConfig creates a new InstancetypeV1alpha2Client for the given config.
...
// NewForConfigOrDie creates a new InstancetypeV1alpha2Client for the given config and
...
func New(c rest.Interface) *InstancetypeV1alpha2Client {
	return &InstancetypeV1alpha2Client{c}
}
