...
The latest bundle is `quay.io/kubevirt/hyperconverged-cluster-bundle:1.10.0-unstable`. It is built and pushed on every merge to
...
spec:
  sourceType: grpc
  image: quay.io/kubevirt/hyperconverged-cluster-index:1.10.0-unstable
