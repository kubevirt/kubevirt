...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyNetwork) DeepCopyInto(out *ProxyNetwork) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyNetwork.
func (in *ProxyNetwork) DeepCopy() *ProxyNetwork {
	if in == nil {
		return nil
	}
	out := new(ProxyNetwork)
