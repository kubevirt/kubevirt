...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtraOptions) DeepCopyInto(out *ExtraOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtraOptions.
func (in *ExtraOptions) DeepCopy() *ExtraOptions {
	if in == nil {
		return nil
	}
	out := new(ExtraOptions)
	in.DeepCopyInto(out)
	return out
}
