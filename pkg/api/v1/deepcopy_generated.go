...
func (in *EvictionPolicy) DeepCopyInto(out *EvictionPolicy) {
	*out = *in
	if in.Taints != nil {
		...
		*out = make([]TaintEvictionPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaintEvictionPolicy) DeepCopyInto(out *TaintEvictionPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaintEvictionPolicy.
func (in *TaintEvictionPolicy) DeepCopy() *TaintEvictionPolicy {
	if in == nil {
		return nil
	}
	out := new(TaintEvictionPolicy)
	in.DeepCopyInto(out)
	return out
}
