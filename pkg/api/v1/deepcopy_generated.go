...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMPresetSpec) DeepCopyInto(out *VMPresetSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMPresetSpec.
func (in *VMPresetSpec) DeepCopy() *VMPresetSpec {
	if in == nil {
		return nil
	}
	out := new(VMPresetSpec)
	in.DeepCopyInto(out)
	return out
}
