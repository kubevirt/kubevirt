...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PresetDomainSpec) DeepCopyInto(out *PresetDomainSpec) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
	if in.CPU != nil {
		in, out := &in.CPU, &out.CPU
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PresetDomainSpec.
func (in *PresetDomainSpec) DeepCopy() *PresetDomainSpec {
	if in == nil {
		return nil
	}
	out := new(PresetDomainSpec)
	in.DeepCopyInto(out)
	return out
}
