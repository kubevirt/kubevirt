...
func setDefaults_IOThreads(obj *VirtualMachineInstance) {
	ioThreads := obj.Spec.Domain.IOThreads
	if ioThreads != nil {
		if ioThreads.ThreadCount == nil {
			numIOThreads := uint(1)
			ioThreads.ThreadCount = &numIOThreads
		}
	}
}
