...
func (_m *MockCmdClient) SSHKeyVirtualMachine(ctx context.Context, in *SSHKeyRequest, opts ...grpc.CallOption) (*Response, error) {
	_s := []interface{}{ctx, in}
	for _, _x := range opts {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "SSHKeyVirtualMachine", _s...)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockCmdClientRecorder) SSHKeyVirtualMachine(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0, arg1}, arg2...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "SSHKeyVirtualMachine", _s...)
}
...
func (_m *MockCmdServer) SSHKeyVirtualMachine(_param0 context.Context, _param1 *SSHKeyRequest) (*Response, error) {
	ret := _m.ctrl.Call(_m, "SSHKeyVirtualMachine", _param0, _param1)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockCmdServerRecorder) SSHKeyVirtualMachine(arg0, arg1 interface{}) *gomock.Call {
