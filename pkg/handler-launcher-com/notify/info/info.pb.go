...
type NotifyInfoResponse struct {
	SupportedNotifyVersions      []string `protobuf:"bytes,1,rep,name=supportedNotifyVersions" json:"supportedNotifyVersions,omitempty"`
	SupportedDomainVersions      []string `protobuf:"bytes,2,rep,name=supportedDomainVersions" json:"supportedDomainVersions,omitempty"`
	SupportedK8SMetaAPIVersions  []string `protobuf:"bytes,3,rep,name=supportedK8SMetaAPIVersions" json:"supportedK8SMetaAPIVersions,omitempty"`
	SupportedK8SEventAPIVersions []string `protobuf:"bytes,4,rep,name=supportedK8SEventAPIVersions" json:"supportedK8SEventAPIVersions,omitempty"`
}
...
func (m *NotifyInfoResponse) GetSupportedNotifyVersions() []string {
	if m != nil {
...
func (m *NotifyInfoResponse) GetSupportedDomainVersions() []string {
	if m != nil {
...
func (m *NotifyInfoResponse) GetSupportedK8SMetaAPIVersions() []string {
	if m != nil {
		return m.SupportedK8SMetaAPIVersions
	}
	return nil
}

func (m *NotifyInfoResponse) GetSupportedK8SEventAPIVersions() []string {
	if m != nil {
		return m.SupportedK8SEventAPIVersions
	}
	return nil
}
...
var fileDescriptor0 = []byte{
	...
	,
}
