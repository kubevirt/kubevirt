...
var snapshotIndicationMessages = map[snapshotv1.Indication]string{
	snapshotv1.VMSnapshotOnlineSnapshotIndication: "Running VMI snapshot; quiesce attempted for application consistency.",
	snapshotv1.VMSnapshotGuestAgentIndication:     "Guest agent available, enabling an application-consistent snapshot.",
	snapshotv1.VMSnapshotNoGuestAgentIndication:   "No guest agent; snapshot is not application-consistent (crash-consistent only).",
	snapshotv1.VMSnapshotQuiesceFailedIndication:  "Filesystem quiescing failed; snapshot is not application-consistent (crash-consistent only).",
	snapshotv1.VMSnapshotPausedIndication:         "Paused domain prevented an application-consistent snapshot.",
}
