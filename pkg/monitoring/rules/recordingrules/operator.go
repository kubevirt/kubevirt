...
var operatorRecordingRules = []operatorrules.RecordingRule{
	{
		MetricsOpts: operatormetrics.MetricOpts{
			Name: "kubevirt_memory_working_set_to_requested_diff_bytes",
			Help: "The diff between the pod with highest memory working set and its requested memory for each container, virt-controller, virt-handler, virt-api and virt-operator.",
	...
	{
		MetricsOpts: operatormetrics.MetricOpts{
			Name: "kubevirt_memory_rss_to_requested_diff_bytes",
			Help: "The diff between the pod with highest memory RSS and its requested memory for each container, virt-controller, virt-handler, virt-api and virt-operator.",
			ConstLabels: map[string]string{
