...
// When both have value 1, topk picks alphabetically — ErrImagePull
// wins over ImagePullBackOff. Outer max-by strips the container
// label so it doesn't leak into alert routing or grouping.
//
