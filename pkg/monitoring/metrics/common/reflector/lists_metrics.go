...
var (
	listsMetrics = []operatormetrics.Metric{
		listsTotal,
		listsDuration,
		itemsPerList,
	}

	listsTotal = operatormetrics.NewCounterVec(
	...
	listsDuration = operatormetrics.NewSummaryVec(
		operatormetrics.MetricOpts{
	...
	itemsPerList = operatormetrics.NewSummaryVec(
		operatormetrics.MetricOpts{
