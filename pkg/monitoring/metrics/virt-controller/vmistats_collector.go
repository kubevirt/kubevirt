...
func newVMICountMetric(vmi *k6tv1.VirtualMachineInstance) vmiCountMetric {
	vmc := vmiCountMetric{
		...
		GuestOSKernelRelease: vmi.Status.GuestOSInfo.KernelRelease,
		GuestOSMachine:       vmi.Status.GuestOSInfo.Machine,
		GuestOSName:          vmi.Status.GuestOSInfo.Name,
		GuestOSVersionID:     vmi.Status.GuestOSInfo.VersionID,
	}
