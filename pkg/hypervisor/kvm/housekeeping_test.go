...
func makeVMI(isolateEmulator, isolateVhost bool) *v1.VirtualMachineInstance {
	...
	vmi.Spec.Domain.CPU = &v1.CPU{
		...
		IsolateVhostThread:    isolateVhost,
	}
	return vmi
}
...
var _ = Describe("configureHousekeepingCgroup with vhost isolation", func() {
	...
	It("should return error when vhost thread not yet in cgroup", func() {
		processMap[100] = &fakeProcess{pid: 100, comm: "CPU 0/KVM"}
		processMap[300] = &fakeProcess{pid: 300, comm: "worker"}
		...
		Expect(err.Error()).To(ContainSubstring("will retry"))
	})

	It("should return error when VhostCPUSet is empty", func() {
		processMap[100] = &fakeProcess{pid: 100, comm: "CPU 0/KVM"}
		processMap[200] = &fakeProcess{pid: 200, comm: "vhost-99"}
		processMap[300] = &fakeProcess{pid: 300, comm: "worker"}
	...
	It("should not isolate vhost when IsolateVhostThread is false", func() {
		processMap[100] = &fakeProcess{pid: 100, comm: "CPU 0/KVM"}
		processMap[200] = &fakeProcess{pid: 200, comm: "vhost-99"}
		processMap[300] = &fakeProcess{pid: 300, comm: "worker"}
	...
	It("should return error when AttachTID to vhost cgroup fails", func() {
		processMap[100] = &fakeProcess{pid: 100, comm: "CPU 0/KVM"}
		processMap[200] = &fakeProcess{pid: 200, comm: "vhost-99"}
