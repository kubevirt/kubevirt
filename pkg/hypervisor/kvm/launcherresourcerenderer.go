...
type KvmLauncherResourceRenderer struct{}

func NewKvmLauncherResourceRenderer() *KvmLauncherResourceRenderer {
	return &KvmLauncherResourceRenderer{}
}

func (k *KvmLauncherResourceRenderer) GetHypervisorDevice() string {
	return "kvm"
}

func (k *KvmLauncherResourceRenderer) GetVirtType() string {
	return "kvm"
}

func (k *KvmLauncherResourceRenderer) GetHypervisorDeviceMinorNumber() int64 {
	return 232
}
...
func (k *KvmLauncherResourceRenderer) GetMemoryOverhead(vmi *v1.VirtualMachineInstance, cpuArch string, additionalOverheadRatio *string) resource.Quantity {
