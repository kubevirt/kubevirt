...
type MshvHypervisorBackend struct{}

func NewMshvHypervisorBackend() *MshvHypervisorBackend {
	return &MshvHypervisorBackend{}
}

func (k *MshvHypervisorBackend) GetHypervisorDevice() string {
	return mshvHypervisorDevice
}

func (k *MshvHypervisorBackend) GetVirtType() string {
	return mshvVirtType
}
...
func (k *MshvHypervisorBackend) GetMemoryOverhead(vmi *v1.VirtualMachineInstance, cpuArch string, additionalOverheadRatio *string) resource.Quantity {
