...
type CapabilityKey int // Unique identifier for a capability
type SupportLevel int  // Defines the level of support for a capability on a given platform

// Support on a specific platform (e.g., AMD64+MSHV) can be of the following types:
const (
