...
func (c *createPreference) optFns() map[string]func(*instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error {
	return map[string]func(*instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error{
...
func (c *createPreference) withVolumeStorageClass(preferenceSpec *instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error {
	preferenceSpec.Volumes = &instancetypeinstancetypev1.VolumePreferences{
		PreferredStorageClassName: c.preferredStorageClass,
	}
	return nil
}

func (c *createPreference) withMachineType(preferenceSpec *instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error {
	preferenceSpec.Machine = &instancetypeinstancetypev1.MachinePreferences{
		PreferredMachineType: c.machineType,
	}
	return nil
}

func (c *createPreference) withCPUTopology(preferenceSpec *instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error {
	preferredCPUTopology := instancetypeinstancetypev1.PreferredCPUTopology(c.cpuTopology)
	...
	preferenceSpec.CPU = &instancetypeinstancetypev1.CPUPreferences{
...
func (c *createPreference) newClusterPreference() *instancetypeinstancetypev1.VirtualMachineClusterPreference {
	return &instancetypeinstancetypev1.VirtualMachineClusterPreference{
...
func (c *createPreference) newPreference() *instancetypeinstancetypev1.VirtualMachinePreference {
	preference := &instancetypeinstancetypev1.VirtualMachinePreference{
		TypeMeta: metav1.TypeMeta{
...
func (c *createPreference) applyFlags(cmd *cobra.Command, preferenceSpec *instancetypeinstancetypev1.VirtualMachinePreferenceSpec) error {
