...
import (
	...
	instancetypeinstancetypev1 "kubevirt.io/api/instancetype/v1"
...
func (c *createInstancetype) optFns() map[string]func(*instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error {
	return map[string]func(*instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error{
		GPUFlag:             c.withGPUs,
...
func (c *createInstancetype) withGPUs(instancetypeSpec *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error {
...
func (c *createInstancetype) withHostDevices(instancetypeSpec *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error {
...
func (c *createInstancetype) withIOThreadsPolicy(instancetypeSpec *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error {
...
func (c *createInstancetype) newInstancetype() *instancetypeinstancetypev1.VirtualMachineInstancetype {
	instancetype := &instancetypeinstancetypev1.VirtualMachineInstancetype{
		TypeMeta: metav1.TypeMeta{
			Kind:       "VirtualMachineInstancetype",
			APIVersion: instancetypeinstancetypev1.SchemeGroupVersion.String(),
		},
		ObjectMeta: metav1.ObjectMeta{
			Name: c.name,
		},
		Spec: instancetypeinstancetypev1.VirtualMachineInstancetypeSpec{
			CPU: instancetypeinstancetypev1.CPUInstancetype{
				Guest: c.cpu,
			},
			Memory: instancetypeinstancetypev1.MemoryInstancetype{
...
func (c *createInstancetype) newClusterInstancetype() *instancetypeinstancetypev1.VirtualMachineClusterInstancetype {
	return &instancetypeinstancetypev1.VirtualMachineClusterInstancetype{
		TypeMeta: metav1.TypeMeta{
...
func (c *createInstancetype) applyFlags(cmd *cobra.Command, instancetypeSpec *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) error {
