...
func GetInstanceTypeSpecFromAdmissionRequest(request *admissionv1.AdmissionRequest) (new *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec, old *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec, err error) {

	raw := request.Object.Raw
	instancetypeObj := instancetypeinstancetypev1.VirtualMachineInstancetype{}
	...
	if request.Operation == admissionv1.Update {
		...
		oldInstancetypeObj := instancetypeinstancetypev1.VirtualMachineInstancetype{}
...
func GetPreferenceSpecFromAdmissionRequest(request *admissionv1.AdmissionRequest) (new *instancetypeinstancetypev1.VirtualMachinePreferenceSpec, old *instancetypeinstancetypev1.VirtualMachinePreferenceSpec, err error) {
	raw := request.Object.Raw
	preferenceObj := instancetypeinstancetypev1.VirtualMachinePreference{}
	...
	if request.Operation == admissionv1.Update {
		raw := request.OldObject.Raw
		oldPreferenceObj := instancetypeinstancetypev1.VirtualMachinePreference{}
