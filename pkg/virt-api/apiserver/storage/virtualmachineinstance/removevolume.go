...
func (r *RemoveVolumeREST) Connect(ctx context.Context, name string, _ runtime.Object, responder rest.Responder) (http.Handler, error) {
	...
	if !ok {
		return nil, apierrors.NewBadRequest("namespace is required to remove a volume from a VirtualMachineInstance")
	}
	...
	return http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		...
		if statusErr := r.remover.RemoveVolume(req.Context(), namespace, name, opts, true); statusErr != nil {
