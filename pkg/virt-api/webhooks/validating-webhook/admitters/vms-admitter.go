...
type instancetypeVMsAdmitter interface {
	ApplyToVM(vm *v1.VirtualMachine) (
		*instancetypeinstancetypev1.VirtualMachineInstancetypeSpec,
		*instancetypeinstancetypev1.VirtualMachinePreferenceSpec,
		[]metav1.StatusCause,
	)
	Check(*instancetypeinstancetypev1.VirtualMachineInstancetypeSpec,
		*instancetypeinstancetypev1.VirtualMachinePreferenceSpec,
