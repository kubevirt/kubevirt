...
var _ = Describe("Validating VM Admitter", func() {
	...
	Context("Instancetype", func() {
		...
		It("should reject if instancetype fails to apply to VMI", func() {
			...
			instancetypeMethods.ApplyToVmiFunc = func(_ *k8sfield.Path, _ *instancetypev1alpha3.VirtualMachineInstancetypeSpec, _ *instancetypev1alpha3.VirtualMachinePreferenceSpec, _ *v1.VirtualMachineInstanceSpec) instancetype.Conflicts {
		...
		It("should apply instancetype to VMI before validating VMI", func() {
			...
			instancetypeMethods.ApplyToVmiFunc = func(_ *k8sfield.Path, _ *instancetypev1alpha3.VirtualMachineInstancetypeSpec, _ *instancetypev1alpha3.VirtualMachinePreferenceSpec, vmiSpec *v1.VirtualMachineInstanceSpec) instancetype.Conflicts {
