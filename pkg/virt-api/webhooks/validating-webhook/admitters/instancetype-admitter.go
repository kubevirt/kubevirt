...
func (f *InstancetypeAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitInstancetype(ar,
		...
		func(raw []byte) (*instancetypev1beta1.VirtualMachineInstancetype, error) {
...
type extractInstancetypeFunc = func([]byte) (*instancetypev1beta1.VirtualMachineInstancetype, error)
...
func (f *ClusterInstancetypeAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitClusterInstancetype(ar,
		...
		func(raw []byte) (*instancetypev1beta1.VirtualMachineClusterInstancetype, error) {
...
type extractClusterInstancetypeFunc = func([]byte) (*instancetypev1beta1.VirtualMachineClusterInstancetype, error)
