...
func (f *PreferenceAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitPreference(ar,
		...
		func(raw []byte) (*instancetypev1beta1.VirtualMachinePreference, error) {
...
type extractPreferenceFunc = func([]byte) (*instancetypev1beta1.VirtualMachinePreference, error)
...
func (f *ClusterPreferenceAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitClusterPreference(ar,
		...
		func(raw []byte) (*instancetypev1beta1.VirtualMachineClusterPreference, error) {
...
type extractClusterPreferenceFunc = func([]byte) (*instancetypev1beta1.VirtualMachineClusterPreference, error)
