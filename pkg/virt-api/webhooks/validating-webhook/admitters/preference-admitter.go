...
func (f *PreferenceAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitPreference(ar,
		...
		func(raw []byte) (*instancetypev1alpha3.VirtualMachinePreference, error) {
...
type extractPreferenceFunc = func([]byte) (*instancetypev1alpha3.VirtualMachinePreference, error)
...
func (f *ClusterPreferenceAdmitter) Admit(ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	return admitClusterPreference(ar,
		...
		func(raw []byte) (*instancetypev1alpha3.VirtualMachineClusterPreference, error) {
			clusterPreferenceObj := &instancetypev1alpha3.VirtualMachineClusterPreference{}
...
type extractClusterPreferenceFunc = func([]byte) (*instancetypev1alpha3.VirtualMachineClusterPreference, error)
