...
// ValidateSpec validates the given VMI spec
type ValidateSpec func(*k8sfield.Path, *v1.VirtualMachineInstanceSpec, *virtconfig.ClusterConfig) []metav1.StatusCause

type VMICreateAdmitter struct {
	ClusterConfig  *virtconfig.ClusterConfig
	SpecValidators []ValidateSpec
}
