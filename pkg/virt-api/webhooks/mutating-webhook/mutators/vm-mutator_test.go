...
var _ = Describe("VirtualMachine Mutator", func() {
	...
	DescribeTable("should apply configurable defaults on VM create", func(arch string, amd64MachineType string, arm64MachineType string, ppcle64MachineType string, s390xMachineType string, result string) {
