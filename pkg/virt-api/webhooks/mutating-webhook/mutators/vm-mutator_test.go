...
var _ = Describe("VirtualMachine Mutator", func() {
	...
	It("should allow VM with memory.guest as an integer using raw JSON", func() {
		...
		Expect(resp.Allowed).To(BeTrue(), "Expected the VM with memory.guest as integer to be allowed")
	})
