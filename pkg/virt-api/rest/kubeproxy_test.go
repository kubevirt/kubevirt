...
var _ = Describe("Kubeproxy", func() {
	...
	Context("To allow autodiscovery for kubectl", func() {
		It("should proxy /apis/kubevirt.io/v1alpha3/", func() {
			apiserverMock.AppendHandlers(
				ghttp.CombineHandlers(
					ghttp.VerifyRequest(http.MethodGet, "/apis/kubevirt.io/v1alpha3/"),
					ghttp.RespondWithJSONEncoded(http.StatusOK, sourceVMI),
				),
			)
			result := restClient.Get().AbsPath("/apis/kubevirt.io/v1alpha3/").Do()
...
func vmiBasePath() string {
	return "/apis/kubevirt.io/v1alpha3/namespaces/default/virtualmachineinstances"
}
