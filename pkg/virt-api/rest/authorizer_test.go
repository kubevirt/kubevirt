	...
	Describe("KubeVirt Subresources", func() {
		...
		Context("Subresource api with namespaced resource", func() {
			...
			DescribeTable("should allow all users for info endpoints", func(path string) {
				...
				Entry("openapiv3", "/openapi/v3"),
				Entry("openapiv3/apis/subresources.kubevirt.io/v1", "/openapi/v3/apis/subresources.kubevirt.io/v1"),
				Entry("openapiv3/apis/subresources.kubevirt.io/v1alpha3", "/openapi/v3/apis/subresources.kubevirt.io/v1alpha3"),
