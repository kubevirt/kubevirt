	...
	Context("Add/Remove Interface Subresource api", func() {
		...
		DescribeTable("Should generate expected vmi patch", func(interfaceRequest *v1.VirtualMachineInterfaceRequest, expectedPatch string) {
			...
			Entry("when the add interface request features all required data",
				...
				fmt.Sprintf("[{ \"op\": \"test\", \"path\": \"/spec/networks\", \"value\": [{\"name\":\"%[1]s\"}]}, { \"op\": \"test\", \"path\": \"/spec/domain/devices/interfaces\", \"value\": [{\"name\":\"%[1]s\"}]}, { \"op\": \"replace\", \"path\": \"/spec/networks\", \"value\": [{\"name\":\"%[1]s\"},{\"name\":\"%[2]s\",\"multus\":{\"networkName\":\"%[3]s\"}}]}, { \"op\": \"replace\", \"path\": \"/spec/domain/devices/interfaces\", \"value\": [{\"name\":\"%[1]s\"},{\"name\":\"%[2]s\"}]}]", ifaceToRemove, ifaceToHotplug, networkToHotplug)),
