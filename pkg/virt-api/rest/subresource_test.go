...
var _ = Describe("VirtualMachineInstance Subresources", func() {
	...
	Context("Pausing", func() {
		...
		nilAdditionalVMIOps := func(vmi *v1.VirtualMachineInstance) {
			return
		}
		...
		DescribeTable("Should fail unpausing due to VMI state", func(running bool, paused bool, vmiOps func(*v1.VirtualMachineInstance), unpauseOptions *v1.UnpauseOptions, expectedError string) {
			...
			Entry("a running, not paused VMI", Running, UnPaused, nilAdditionalVMIOps, &v1.UnpauseOptions{}, "VMI is not paused"),
			Entry("a running, not paused VMI with dry-run option", Running, UnPaused, nilAdditionalVMIOps, &v1.UnpauseOptions{DryRun: withDryRun()}, "VMI is not paused"),

			Entry("a not running VMI", NotRunning, UnPaused, nilAdditionalVMIOps, &v1.UnpauseOptions{}, "VMI is not running"),
			Entry("a not running VMI with dry-run option", NotRunning, UnPaused, nilAdditionalVMIOps, &v1.UnpauseOptions{DryRun: withDryRun()}, "VMI is not running"),
