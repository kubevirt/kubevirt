...
func (app *SubresourceAPIApp) vmVolumePatch(ctx context.Context, name, namespace string, volumeRequest *v1.VirtualMachineVolumeRequest) *errors.StatusError {
	...
	if _, err := app.virtClient.VirtualMachine(vm.Namespace).Patch(ctx, vm.Name, types.JSONPatchType, patchBytes, metav1.PatchOptions{DryRun: dryRunOption}); err != nil {
...
func (app *SubresourceAPIApp) vmiVolumePatch(ctx context.Context, name, namespace string, volumeRequest *v1.VirtualMachineVolumeRequest) *errors.StatusError {
	...
	if _, err := app.virtClient.VirtualMachineInstance(vmi.Namespace).Patch(ctx, vmi.Name, types.JSONPatchType, patchBytes, metav1.PatchOptions{DryRun: dryRunOption}); err != nil {
...
func (app *SubresourceAPIApp) vmVolumePatchStatus(ctx context.Context, name, namespace string, volumeRequest *v1.VirtualMachineVolumeRequest) *errors.StatusError {
	...
	if _, err = app.virtClient.VirtualMachine(vm.Namespace).PatchStatus(ctx, vm.Name, types.JSONPatchType, patchBytes, metav1.PatchOptions{DryRun: dryRunOption}); err != nil {
