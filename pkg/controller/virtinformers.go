...
type KubeInformerFactory interface {
	...
	DummyResourceClaimTemplate() cache.SharedIndexInformer
...
func (f *kubeInformerFactory) DummyResourceClaimTemplate() cache.SharedIndexInformer {
	return f.getInformer("fakeResourceClaimTemplateInformer", func() cache.SharedIndexInformer {
		informer, _ := testutils.NewFakeInformerFor(&resourcev1.ResourceClaimTemplate{})
		return informer
	})
}
