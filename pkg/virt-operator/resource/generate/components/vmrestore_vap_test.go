...
var _ = Describe("VirtualMachineRestore Validation Admission Policy", func() {
	...
	Context("ValidatingAdmissionPolicy", func() {
		It("should generate the expected policy", func() {
			...
			Expect(messages).To(ContainElements(
				components.VMRestoreErrFeatureGateDisabled,
				components.VMRestoreErrMissingAPIGroup,
				components.VMRestoreErrInvalidAPIGroup,
				components.VMRestoreErrInvalidKind,
				components.VMRestoreErrSpecImmutable,
				components.VMRestoreErrVolumeOverrideVolumeName,
				components.VMRestoreErrVolumeOverrideAtLeastOneField,
				components.VMRestoreErrInvalidVolumeRestorePolicy,
				components.VMRestoreErrInvalidVolumeOwnershipPolicy,
				components.VMRestoreErrInvalidPatchPath,
			))
		})
	})
	...
	Context("ValidatingAdmissionPolicyBinding", func() {
		It("should generate the expected policy binding", func() {
			...
			Expect(binding.Name).To(Equal("vmrestore-policy-binding"))
