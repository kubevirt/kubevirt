...
var _ = Describe("Plugin CRD validation rules", func() {
	...
	DescribeTable("should accept", func(path string, self interface{}) {
		...
		Entry("launcher hook point PreBoot", "spec.launcherHooks[].cel.hookPoint", v1alpha1.LauncherHookPreBoot),
		Entry("launcher hook point PreMigrationSource", "spec.launcherHooks[].cel.hookPoint", v1alpha1.LauncherHookPreMigrationSource),
		Entry("permitted launcher hook point PreBoot", "spec.launcherHooks[].sidecar.permittedHooks[]", v1alpha1.LauncherHookPreBoot),
	...
	DescribeTable("should reject", func(path string, self interface{}, expectedMessage string) {
		...
		Entry("an unknown launcher hook point on a cel hook", "spec.launcherHooks[].cel.hookPoint",
			v1alpha1.NodeHookPostVMStart, "hook point must be one of"),
		Entry("a node hook point used as a launcher hook point", "spec.launcherHooks[].sidecar.permittedHooks[]",
			v1alpha1.NodeHookPreMigrationTarget, "hook point must be one of"),
		Entry("a misspelled launcher hook point", "spec.launcherHooks[].sidecar.permittedHooks[]",
			"guestdefinition", "hook point must be one of"),
		Entry("an unknown node hook point", "spec.nodeHooks[].permittedHooks[]",
			v1alpha1.LauncherHookPreBoot, "hook point must be one of"),
