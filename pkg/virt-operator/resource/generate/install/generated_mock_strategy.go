...
import (
	...
	v11 "github.com/openshift/api/security/v1"
...
func (_m *MockStrategyInterface) SCCs() []*v11.SecurityContextConstraints {
	ret := _m.ctrl.Call(_m, "SCCs")
	ret0, _ := ret[0].([]*v11.SecurityContextConstraints)
	return ret0
}
...
func (_m *MockStrategyInterface) ServiceMonitors() []*v1.ServiceMonitor {
...
func (_m *MockStrategyInterface) PrometheusRules() []*v1.PrometheusRule {
	ret := _m.ctrl.Call(_m, "PrometheusRules")
	ret0, _ := ret[0].([]*v1.PrometheusRule)
	return ret0
}
...
func (_m *MockStrategyInterface) Routes() []*v10.Route {
