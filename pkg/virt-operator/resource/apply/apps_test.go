...
var _ = Describe("Apply Apps", func() {
	...
	Context("on calling syncDeployment", func() {
		...
		Context("virt-template TLS injection", func() {
			...
			DescribeTable("should inject TLS config for virt-template deployments", func(deploymentName string, tlsConfig *v1.TLSConfiguration, expectedCiphers, expectedMinVersion string) {
