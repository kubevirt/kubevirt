...
func containerPathVolumesEnabled(kv *v1.KubeVirt) bool {
	return featuregate.IsFeatureGateEnabled(featuregate.ContainerPathVolumesGate, kv.Spec.Configuration.DeveloperConfiguration)
}

func synchronizationControllerEnabled(kv *v1.KubeVirt) bool {
	return featuregate.IsFeatureGateEnabled(featuregate.DecentralizedLiveMigration, kv.Spec.Configuration.DeveloperConfiguration)
}

func virtTemplateDeploymentEnabled(kv *v1.KubeVirt) bool {
	if !featuregate.IsFeatureGateEnabled(featuregate.Template, kv.Spec.Configuration.DeveloperConfiguration) {
		return false
	}
