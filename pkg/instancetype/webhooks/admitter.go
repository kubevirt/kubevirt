...
func ValidateInstanceTypeSpec(field *k8sfield.Path, spec *instancetypeinstancetypev1.VirtualMachineInstancetypeSpec) []metav1.StatusCause {
...
func admitInstancetype(request *admissionv1.AdmissionRequest, resource string) *admissionv1.AdmissionResponse {
	...
	gvk := schema.GroupVersionKind{
		Group:   instancetypeinstancetypev1.SchemeGroupVersion.Group,
		Kind:    resource,
