...
func (c *controller) Sync(vm *virtv1.VirtualMachine, vmi *virtv1.VirtualMachineInstance) (*virtv1.VirtualMachine, error) {
	...
	case virtv1.Reference:
		...
		if err := c.Store(vm); err != nil {
			...
			c.recorder.Eventf(vm, k8score.EventTypeWarning, common.FailedCreateVirtualMachineReason, storeControllerRevisionErrFmt, err)
	...
	case virtv1.Expand, virtv1.ExpandAll:
		if shouldExpand(vm, referencePolicy) {
			return c.handleExpand(vm)
		}
	}
	...
	if err := c.Upgrade(vm); err != nil {
		...
		c.recorder.Eventf(vm, k8score.EventTypeWarning, common.FailedCreateVirtualMachineReason, upgradeControllerRevisionErrFmt, err)
		return vm, common.NewSyncError(fmt.Errorf(upgradeControllerRevisionErrFmt, err), common.FailedCreateVirtualMachineReason)
	}
	return vm, nil
}

func shouldExpand(vm *virtv1.VirtualMachine, referencePolicy virtv1.InstancetypeReferencePolicy) bool {
...
func (c *controller) handleExpand(vm *virtv1.VirtualMachine) (*virtv1.VirtualMachine, error) {
