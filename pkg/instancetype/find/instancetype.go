...
func (f *instancetypeFinder) Find(vm *virtv1.VirtualMachine) (*instancetypev1.VirtualMachineInstancetype, error) {
	...
	instancetype, ok := obj.(*instancetypev1.VirtualMachineInstancetype)
	if !ok {
