	...
	Context("Apply", func() {
		...
		Context("Preference.Devices", func() {
			...
			BeforeEach(func() {
				...
				preferenceSpec = &instancetypev1beta1.VirtualMachinePreferenceSpec{
					Devices: &instancetypev1beta1.DevicePreferences{
						...
						PreferredPanicDevices:        []v1.PanicDevice{{Model: pointer.P(v1.PanicDeviceModelHyperv)}, {}},
					},
				}
			})
			...
			It("Should apply the missing PanicDevice preferences to a VMI", func() {
				...
				hypervPanicDeviceTest := v1.PanicDevice{Model: pointer.P(v1.PanicDeviceModelHyperv)}
				isaPanicDeviceTest := v1.PanicDevice{Model: pointer.P(v1.PanicDeviceModelIsa)}
