...
var _ = Describe("ControllerRevision Upgrader", func() {
	...
	Context("should", func() {
		...
		expectVirtualMachineRevisionNamePatch := func() {
			// TODO(lyarwood) - assert the revisionName patch, GenerateRevisionNamePatch needs to be refactored first
		...
		updateInstancetypeMatcher := func(revisonName string) {
			vm.Spec.Instancetype = &virtv1.InstancetypeMatcher{
				RevisionName: revisonName,
			}
		}

		updatePreferenceMatcher := func(revisonName string) {
		...
		DescribeTable("upgrade ControllerRevision containing", func(createOriginalCR func(*virtv1.VirtualMachine) (*appsv1.ControllerRevision, error), updateMatcher func(string)) {
			...
			if originalCR.Data.Raw == nil && originalCR.Data.Object != nil {
