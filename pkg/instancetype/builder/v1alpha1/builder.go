...
type InstancetypeSpecOption func(*v1alpha1.VirtualMachineInstancetypeSpec)

func NewInstancetype(opts ...InstancetypeSpecOption) *v1alpha1.VirtualMachineInstancetype {
...
func NewClusterInstancetype(opts ...InstancetypeSpecOption) *v1alpha1.VirtualMachineClusterInstancetype {
...
func newInstancetypeSpec(opts ...InstancetypeSpecOption) v1alpha1.VirtualMachineInstancetypeSpec {
...
func WithCPUs(vCPUs uint32) InstancetypeSpecOption {
	return func(spec *v1alpha1.VirtualMachineInstancetypeSpec) {
...
func fromVMI(vmi *virtv1.VirtualMachineInstance) InstancetypeSpecOption {
	return func(spec *v1alpha1.VirtualMachineInstancetypeSpec) {
		...
		spec.CPU = v1alpha1.CPUInstancetype{
			Guest: uint32(1),
		}
...
func NewInstancetypeFromVMI(vmi *virtv1.VirtualMachineInstance) *v1alpha1.VirtualMachineInstancetype {
	return NewInstancetype(
		fromVMI(vmi),
	)
}

func NewClusterInstancetypeFromVMI(vmi *virtv1.VirtualMachineInstance) *v1alpha1.VirtualMachineClusterInstancetype {
	return NewClusterInstancetype(
		fromVMI(vmi),
	)
}

type PreferenceSpecOption func(*v1alpha1.VirtualMachinePreferenceSpec)

func newPreferenceSpec(opts ...PreferenceSpecOption) v1alpha1.VirtualMachinePreferenceSpec {
...
func NewPreference(opts ...PreferenceSpecOption) *v1alpha1.VirtualMachinePreference {
...
func NewClusterPreference(opts ...PreferenceSpecOption) *v1alpha1.VirtualMachineClusterPreference {
...
func WithPreferredCPUTopology(topology v1alpha1.PreferredCPUTopology) PreferenceSpecOption {
	return func(spec *v1alpha1.VirtualMachinePreferenceSpec) {
		if spec.CPU == nil {
			spec.CPU = &v1alpha1.CPUPreferences{}
		}
