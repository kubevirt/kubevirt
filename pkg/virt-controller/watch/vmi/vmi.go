...
func (c *Controller) updatePod(old, cur interface{}) {
	...
	if curPod.DeletionTimestamp != nil {
		...
		c.deletePodHandle(curPod)
		if labelChanged {
			// we don't need to check the oldPod.DeletionTimestamp because DeletionTimestamp cannot be unset.
			c.deletePodHandle(oldPod)
		}
		return
	}
...
func (c *Controller) deletePodHandle(obj interface{}) {
...
func (c *Controller) deleteAllMatchingPods(vmi *virtv1.VirtualMachineInstance) error {
	...
	for _, pod := range pods {
		...
		err = c.deletePod(vmiKey, pod, v1.DeleteOptions{})
		if err != nil {
