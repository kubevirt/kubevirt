...
func (c *Controller) updateStatus(vm, vmOrig *virtv1.VirtualMachine, vmi *virtv1.VirtualMachineInstance, syncErr common.SyncError, logger *log.FilteredLogger) error {
	...
	backup.SyncVMChangedBlockTrackingState(vm, vmi, c.clusterConfig, c.namespaceStore)
...
func (c *Controller) handleKubeVirt(oldObj, newObj interface{}) {
...
func (c *Controller) handleNamespace(oldObj, newObj interface{}) {
