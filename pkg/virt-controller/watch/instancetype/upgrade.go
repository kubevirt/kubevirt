...
func NewUpgradeController(
	...
	_, err := c.crUpgradeInformer.AddEventHandler(
		cache.ResourceEventHandlerFuncs{
			AddFunc:    c.addUpgrade,
			UpdateFunc: c.updateUpgrade,
		},
	)
	if err != nil {
		return nil, err
...
func (c *UpgradeController) enqueueUpgrade(obj interface{}) {
	crUpgrade := obj.(*instancetypev1beta1.ControllerRevisionUpgrade)
...
func (c *UpgradeController) addUpgrade(obj interface{}) {
	c.enqueueUpgrade(obj)
}

func (c *UpgradeController) updateUpgrade(_, currObj interface{}) {
...
func (c *UpgradeController) execute(crUpgradeKey string) error {
...
func upgradeUnset(crUpgrade *instancetypev1beta1.ControllerRevisionUpgrade) bool {
