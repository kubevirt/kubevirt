...
const targetPodIndex = "targetPod"
...
func NewController(templateService templateService,
	...
	return c, addTargetPodIndexer(c.podIndexer)
}

func addTargetPodIndexer(podIndexer cache.Indexer) error {
	return podIndexer.AddIndexers(cache.Indexers{
		targetPodIndex: func(obj interface{}) ([]string, error) {
...
func (c *Controller) listMatchingTargetPods(migration *virtv1.VirtualMachineInstanceMigration, vmi *virtv1.VirtualMachineInstance) ([]*k8sv1.Pod, error) {
	objs, err := c.podIndexer.ByIndex(targetPodIndex, string(vmi.UID))
	if err != nil {
		return nil, err
	}
