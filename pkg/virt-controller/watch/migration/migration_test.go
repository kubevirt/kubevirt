		...
		DescribeTable("resolveMigrationConfig should correctly merge policy onto cluster defaults", func(
			...
			Entry("policy *false overrides cluster *true for bool fields",
				func(kv *v1.KubeVirtConfiguration) {
					kv.MigrationConfiguration = &v1.MigrationConfiguration{LegacyVMMigrationConfiguration: v1.LegacyVMMigrationConfiguration{
						AllowAutoConverge: pointer.P(false),
					}}
				},
				migrationsv1.MigrationPolicySpec{VMMigrationConfiguration: v1.VMMigrationConfiguration{LegacyVMMigrationConfiguration: v1.LegacyVMMigrationConfiguration{
					AllowAutoConverge: pointer.P(false),
				}}},
				func(c *v1.VMIMConfigurationOptions) {
					Expect(c.AllowAutoConverge).ToNot(BeNil())
			...
			Entry("policy overrides bandwidth quantity",
				...
				func() migrationsv1.MigrationPolicySpec {
					...
					return migrationsv1.MigrationPolicySpec{VMMigrationConfiguration: v1.VMMigrationConfiguration{LegacyVMMigrationConfiguration: v1.LegacyVMMigrationConfiguration{
						BandwidthPerMigration: &bw,
					}}}
				}(),
				func(c *v1.VMIMConfigurationOptions) {
