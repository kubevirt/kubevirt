	...
	Context("One valid VirtualMachine controller given", func() {
		...
		Context("Instancetype and Preferences", func() {
			...
			var (
				...
				fakeInstancetypeClient        v1alpha3.VirtualMachineInstancetypeInterface
				fakeClusterInstancetypeClient v1alpha3.VirtualMachineClusterInstancetypeInterface
				fakePreferenceClient          v1alpha3.VirtualMachinePreferenceInterface
				fakeClusterPreferenceClient   v1alpha3.VirtualMachineClusterPreferenceInterface
			...
			Context("instancetype", func() {
				...
				It("should apply VirtualMachineInstancetype to VirtualMachineInstance", func() {
					...
					revisionInstancetype, ok := revision.Data.Object.(*instancetypev1alpha3.VirtualMachineInstancetype)
				...
				It("should apply VirtualMachineClusterInstancetype to VirtualMachineInstance", func() {
					...
					revisionClusterInstancetype, ok := revision.Data.Object.(*instancetypev1alpha3.VirtualMachineClusterInstancetype)
			...
			Context("preference", func() {
				...
				It("should apply VirtualMachinePreference to VirtualMachineInstance", func() {
					...
					preferenceRevisionObj, ok := preferenceRevision.Data.Object.(*instancetypev1alpha3.VirtualMachinePreference)
				...
				It("should apply VirtualMachineClusterPreference to VirtualMachineInstance", func() {
					...
					preferenceRevisionObj, ok := preferenceRevision.Data.Object.(*instancetypev1alpha3.VirtualMachineClusterPreference)
					Expect(ok).To(BeTrue(), "Expected Preference in ControllerRevision")
				...
				It("should reject if an existing ControllerRevision is found with unexpected VirtualMachinePreferenceSpec data", func() {
					...
					unexpectedPreference.Spec.Firmware = &instancetypev1alpha3.FirmwarePreferences{
				...
				It("should apply preferredAutoattachPodInterface and skip adding default network interface", func() {
					...
					autoattachPodInterfacePreference := &instancetypev1alpha3.VirtualMachinePreference{
						ObjectMeta: metav1.ObjectMeta{
				...
				It("should apply preferences to preferredAutoattachInputDevice attached input device", func() {
					...
					autoattachInputDevicePreference := &instancetypev1alpha3.VirtualMachinePreference{
						ObjectMeta: metav1.ObjectMeta{
