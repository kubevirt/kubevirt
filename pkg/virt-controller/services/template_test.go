...
`,
		...
		Context("with multus annotation", func() {
			It("should add multus networks in the pod annotation", func() {
				...
				Expect(ok).To(BeTrue())
				expectedIfaces := ("[" +
					"{\"interface\":\"net37a8eec1\",\"name\":\"default\",\"namespace\":\"default\"}," +
					"{\"interface\":\"net1b4f0e98\",\"name\":\"test1\",\"namespace\":\"default\"}," +
					"{\"interface\":\"net49dba5c7\",\"name\":\"test1\",\"namespace\":\"other-namespace\"}" +
					"]")
			...
			It("should add default multus networks in the multus default-network annotation", func() {
				...
				value, ok = pod.Annotations["k8s.v1.cni.cncf.io/networks"]
				Expect(ok).To(BeTrue())
				Expect(value).To(Equal("[{\"interface\":\"net1b4f0e98\",\"name\":\"test1\",\"namespace\":\"default\"}]"))
			})
			It("should add MAC address in the pod annotation", func() {
				...
				expectedIfaces := ("[" +
					"{\"interface\":\"net37a8eec1\",\"name\":\"default\",\"namespace\":\"default\"}," +
					"{\"interface\":\"net1b4f0e98\",\"mac\":\"de:ad:00:00:be:af\",\"name\":\"test1\",\"namespace\":\"default\"}" +
					"]")
				Expect(value).To(Equal(expectedIfaces))
			})
		})
