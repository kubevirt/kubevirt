...
`,
		...
		Context("with node selectors", func() {
			...
			Context("When scheduling SEV workloads", func() {
				...
				It("should not add SEV-ES node label selector when no SEV policy is set", func() {
					vmi.Spec.Domain.LaunchSecurity = &v1.LaunchSecurity{
						SEV: &v1.SEV{
							Policy: &v1.SEVPolicy{},
						},
				...
				It("should not add SEV-ES node label selector when no SEV-ES policy bit is set", func() {
					vmi.Spec.Domain.LaunchSecurity = &v1.LaunchSecurity{
						SEV: &v1.SEV{
							Policy: &v1.SEVPolicy{
								EncryptedState: nil,
				...
				It("should not add SEV-ES node label selector when SEV-ES policy bit is set to false", func() {
					vmi.Spec.Domain.LaunchSecurity = &v1.LaunchSecurity{
						SEV: &v1.SEV{
							Policy: &v1.SEVPolicy{
