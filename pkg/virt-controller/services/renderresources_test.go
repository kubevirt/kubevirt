...
var _ = Describe("GetMemoryOverhead calculation", func() {
	...
	When("the vmi has probes fields", func() {
		DescribeTable("should add probes overhead", func(startupProbe, livenessProbe, readinessProbe *v1.Probe, probeOverhead resource.Quantity) {
            ...
            Entry("with both startupProbe and readinessProbe", &v1.Probe{Handler: v1.Handler{Exec: &kubev1.ExecAction{}}}, nil, &v1.Probe{Handler: v1.Handler{Exec: &kubev1.ExecAction{}}}, resource.MustParse("120Mi")),
