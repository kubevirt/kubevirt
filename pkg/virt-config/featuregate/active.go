...
func init() {
	...
	RegisterFeatureGate(FeatureGate{Name: NUMAFeatureGate, State: Alpha})
	...
	RegisterFeatureGate(FeatureGate{Name: GPUGate, State: Alpha})
	...
	RegisterFeatureGate(FeatureGate{Name: DockerSELinuxMCSWorkaround, State: Alpha})
	...
	RegisterFeatureGate(FeatureGate{Name: HotplugNetworkIfacesGate, State: Alpha})
	...
	RegisterFeatureGate(FeatureGate{Name: NetworkBindingPlugingsGate, State: Alpha})
	RegisterFeatureGate(FeatureGate{Name: AutoResourceLimitsGate, State: Alpha})
	RegisterFeatureGate(FeatureGate{Name: CommonInstancetypesDeploymentGate, State: Alpha})
