...
// MacvtapGate controls the macvtap network binding.
// Discontinued since v1.3.
const MacvtapGate = "Macvtap"
...
func init() {
	featuregate.RegisterFeatureGate(featuregate.FeatureGate{
		...
		Message:     MacvtapDiscontinueMessage,
		VmiSpecUsed: macvtapApiUsed,
	})
}
