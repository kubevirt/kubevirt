...
func (config *ClusterConfig) CustomSELinuxPolicyDisabled() bool {
	return config.isFeatureGateEnabled(featuregate.DisableCustomSELinuxPolicy)
}
...
func (config *ClusterConfig) VMLiveUpdateFeaturesEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.VMLiveUpdateFeaturesGate)
}

func (config *ClusterConfig) BochsDisplayForEFIGuestsEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.BochsDisplayForEFIGuests)
}

func (config *ClusterConfig) NetworkBindingPlugingsEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.NetworkBindingPlugingsGate)
}
...
func (config *ClusterConfig) VolumesUpdateStrategyEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.VolumesUpdateStrategy)
}

func (config *ClusterConfig) VolumeMigrationEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.VolumeMigration)
}
...
func (config *ClusterConfig) DynamicPodInterfaceNamingEnabled() bool {
	return config.isFeatureGateEnabled(featuregate.DynamicPodInterfaceNamingGate)
}
