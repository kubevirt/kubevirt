...
const (
	...
	liveMigrateOnDrainsGate = "LiveMigrateOnDrains"
)
...
func LiveMigrateOnDrainsEnabled() bool {
	return strings.Contains(os.Getenv(featureGateEnvVar), liveMigrateOnDrainsGate)
}
