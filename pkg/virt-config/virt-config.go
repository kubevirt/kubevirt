...
func (c *ClusterConfig) IsUseEmulation() bool {
	return c.GetConfig().DeveloperConfigurations.UseEmulation
}

func (c *ClusterConfig) GetMigrationConfig() *v1.MigrationConfig {
...
func (c *ClusterConfig) GetMemoryOvercommit() int {
	return c.GetConfig().DeveloperConfigurations.MemoryOvercommit
}
...
func (c *ClusterConfig) GetLessPVCSpaceToleration() int {
	return c.GetConfig().DeveloperConfigurations.LessPVCSpaceToleration
}

func (c *ClusterConfig) GetNodeSelectors() map[string]string {
	return c.GetConfig().DeveloperConfigurations.NodeSelectors
}

func (c *ClusterConfig) GetDefaultNetworkInterface() string {
	return c.GetConfig().NetworkConfigurations.NetworkInterface
}

func (c *ClusterConfig) IsSlirpInterfaceEnabled() bool {
	return c.GetConfig().NetworkConfigurations.PermitSlirpInterface
}
...
func (c *ClusterConfig) IsBridgeInterfaceOnPodNetworkEnabled() bool {
	return c.GetConfig().NetworkConfigurations.PermitBridgeInterfaceOnPodNetwork
}

func (c *ClusterConfig) GetDefaultClusterConfig() *v1.KubevirtConfigurations {
