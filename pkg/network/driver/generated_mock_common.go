...
func (_m *MockNetworkHandler) CreateTapDevice(tapName string, queueNumber uint32, mtu int, tapOwner string) error {
	ret := _m.ctrl.Call(_m, "CreateTapDevice", tapName, queueNumber, mtu, tapOwner)
	ret0, _ := ret[0].(error)
	return ret0
}
