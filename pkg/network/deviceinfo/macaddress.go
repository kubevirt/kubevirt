...
func MapNetworkNameToDeviceMacAddress(networks []v1.Network,
	...
	networkDeviceMacAddresses := map[string]string{}
	for _, iface := range interfaces {
		...
		if exist && networkStatusEntry.Mac != "" {
			networkDeviceMacAddresses[iface.Name] = networkStatusEntry.Mac
		}
	}
	return networkDeviceMacAddresses
}
