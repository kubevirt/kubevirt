...
var _ = Describe("MacAddress", func() {
	...
	networkStatusWithMixedNetworks := []networkv1.NetworkStatus{
		...
		{
			Name:      "default/nad-without-deviceinfo",
			Interface: "pod6446d58d6df",
			Mac:       "8a:37:d9:e7:0f:18",
			DNS:       networkv1.DNS{},
		},
		{
			Name:      "default/nad-with-deviceinfo-without-mac",
		...
		{
			Name:      "default/nad-with-deviceinfo-with-mac",
	...
	DescribeTable("should return an empty map",
		func(networkStatuses []networkv1.NetworkStatus) {
			networks := []v1.Network{*libvmi.MultusNetwork("foo", "default/nad-without-deviceinfo")}
	...
	It("should return network device info mapping with multiple networks", func() {
		networks := []v1.Network{
			...
			*libvmi.MultusNetwork("boo", "default/nad-without-deviceinfo"),
			*libvmi.MultusNetwork("foo", "default/nad-with-deviceinfo-without-mac"),
			*libvmi.MultusNetwork("doo", "default/nad3"),
			*libvmi.MultusNetwork("woo", "default/nad-with-deviceinfo-with-mac"),
		}
