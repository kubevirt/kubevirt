  ...
  "device-info": {
	...
	Context("Comprehensive Merge Testing", func() {
		...
		It("Should preserve CNI arguments when only CNI args are present", func() {
			...
			existingAnnotation := `[{"name":"some-net","namespace":"default","interface":"podb1f51a511f1","cni-args":{"deviceID":"0000:01:00.0","resourceName":"nvidia.com/ib_pf"}}]`
			podAnnotations := map[string]string{
		...
		It("Should preserve multiple fields when merging annotations", func() {
			...
			existingAnnotation := `[{"name":"some-net","namespace":"default","interface":"podb1f51a511f1","mac":"00:11:22:33:44:55","ips":["192.168.1.100"],"cni-args":{"deviceID":"0000:01:00.0"}}]`
			podAnnotations := map[string]string{
				networkv1.NetworkAttachmentAnnot: existingAnnotation,
				networkv1.NetworkStatusAnnot:     `[{"name":"k8s-pod-network","ips":["10.244.196.146"],"default":true,"dns":{}}]`,
			}
		...
		It("Should handle unknown fields gracefully", func() {
			...
			existingAnnotation := `[{"name":"some-net","namespace":"default","interface":"podb1f51a511f1","unknownField":"unknownValue","cni-args":{"deviceID":"0000:01:00.0"}}]`
			podAnnotations := map[string]string{
				networkv1.NetworkAttachmentAnnot: existingAnnotation,
				networkv1.NetworkStatusAnnot:     `[{"name":"k8s-pod-network","ips":["10.244.196.146"],"default":true,"dns":{}}]`,
			}
