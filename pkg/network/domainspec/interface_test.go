...
var _ = Describe("VMI interfaces", func() {
	...
	Context("DomainAttachmentByInterfaceName", func() {
		...
		It("should consider a managedMacvtap type as a tap type", func() {
			vmiIfaces := []v1.Interface{{Name: iface1, Binding: &v1.PluginBinding{Name: binding1}}}
			netBindings := map[string]v1.InterfaceBindingPlugin{binding1: {DomainAttachmentType: v1.ManagedMacvtap}}
