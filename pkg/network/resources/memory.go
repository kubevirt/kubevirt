...
type networkBindingsProvider interface {
	GetNetworkBindings() map[string]v1.InterfaceBindingPlugin
}

type MemoryCalculator struct {
	bindingsProvider networkBindingsProvider
}

func NewMemoryCalculator(bindingsProvider networkBindingsProvider) MemoryCalculator {
