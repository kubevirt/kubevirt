...
func (r *PasstRepairController) MigrationSourceRun(vmi *v1.VirtualMachineInstance, socketDirFunc func(*v1.VirtualMachineInstance) (string, error)) error {
...
func (r *PasstRepairController) MigrationTargetRun(vmi *v1.VirtualMachineInstance, socketDirFunc func(*v1.VirtualMachineInstance) (string, error)) error {
	return r.run(vmi, socketDirFunc)
}

func (r *PasstRepairController) run(vmi *v1.VirtualMachineInstance, socketDirFunc func(*v1.VirtualMachineInstance) (string, error)) error {
...
func (r *PasstRepairController) testAndSetActive(vmiUID types.UID) bool {
	r.mutex.Lock()
...
func (r *PasstRepairController) setInactive(vmiUID types.UID) {
	r.mutex.Lock()
	defer r.mutex.Unlock()
