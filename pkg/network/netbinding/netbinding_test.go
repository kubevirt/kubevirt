...
var _ = Describe("Network Binding", func() {
	...
	Context("binding plugin sidecar list", func() {
		DescribeTable("should create the correct sidecars",
			...
			Entry("VMI has binding plugin with pod-info downwardAPI",
				libvmi.New(libvmi.WithInterface(v1.Interface{Name: testNetworkName1, Binding: &v1.PluginBinding{Name: testBindingName1}}),
					libvmi.WithNetwork(&v1.Network{Name: testNetworkName1}),
				),
				map[string]v1.InterfaceBindingPlugin{testBindingName1: {SidecarImage: testSidecarImage1, DownwardAPI: v1.PodInfo}},
				hooks.HookSidecarList{{Image: testSidecarImage1, DownwardAPI: hooks.DownwardAPI{v1.PodInfo}}}),
			Entry("VMI has multiple plugin bindings",
				...
				hooks.HookSidecarList{{Image: testSidecarImage1, DownwardAPI: hooks.DownwardAPI{v1.DeviceInfo}}, {Image: testSidecarImage2}}),
