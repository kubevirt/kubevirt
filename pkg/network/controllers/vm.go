...
func (v *VMController) Sync(vm *v1.VirtualMachine, vmi *v1.VirtualMachineInstance) (*v1.VirtualMachine, error) {
	...
	hasOrdinalIfaces := hasOrdinalSecondaryIfaces(vmi.Spec.Networks, vmi.Status.Interfaces)
...
func hasOrdinalSecondaryIfaces(
	...
	for _, net := range secondaryNets {
		...
		return namescheme.OrdinalSecondaryInterfaceName(ifaceStatus.PodInterfaceName)
	}
