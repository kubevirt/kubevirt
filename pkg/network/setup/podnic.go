...
func (l *podNIC) PlugPhase1() error {
	...
	if l.bindingTypeOnlyRequiresPhase2Configuration() {
		return nil
	}

	if l.infraConfigurator == nil {
		l.setupDefaultPodNicForHotplug()
	}
...
func (l *podNIC) bindingTypeOnlyRequiresPhase2Configuration() bool {
	// these binding types only require phase2 configuration.
	return l.vmiSpecIface.Macvtap != nil || l.vmiSpecIface.Slirp != nil
}

func (l *podNIC) setupDefaultPodNicForHotplug() {
	l.infraConfigurator = infraconfigurators.NewBridgePodNetworkConfigurator(
		l.vmi,
		l.vmiSpecIface,
		generateInPodBridgeInterfaceName(l.podInterfaceName),
		*l.launcherPID,
