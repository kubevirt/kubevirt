...
type HibernationManager struct {
	...
	HibernateInProgress chan struct{}
}

func NewHibernationManager(connection cli.Connection, metadataCache *metadata.Cache) *HibernationManager {
	return &HibernationManager{
		virConn:             connection,
		metadataCache:       metadataCache,
		HibernateInProgress: make(chan struct{}, MaxConcurrentMemoryDumps),
	}
}

func (m *HibernationManager) MigrationInProgress() bool {
