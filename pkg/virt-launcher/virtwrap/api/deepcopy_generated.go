...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InputDevice) DeepCopyInto(out *InputDevice) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputDevice.
func (in *InputDevice) DeepCopy() *InputDevice {
	if in == nil {
		return nil
	}
	out := new(InputDevice)
