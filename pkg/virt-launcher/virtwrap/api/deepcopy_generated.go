...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TPMSource) DeepCopyInto(out *TPMSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TPMSource.
func (in *TPMSource) DeepCopy() *TPMSource {
	if in == nil {
		return nil
	}
	out := new(TPMSource)
