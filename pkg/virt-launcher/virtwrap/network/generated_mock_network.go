...
func (_m *MockNetworkInterface) PlugPhase1(vmi *v1.VirtualMachineInstance, iface *v1.Interface, network *v1.Network, podInterfaceName string, cleanup bool) error {
	ret := _m.ctrl.Call(_m, "PlugPhase1", vmi, iface, network, podInterfaceName, cleanup)
	ret0, _ := ret[0].(error)
	return ret0
}
