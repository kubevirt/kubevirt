...
func (_m *MockNetworkHandler) CreateTapDevice(tapName string, pid string, isMultiqueue bool) error {
	ret := _m.ctrl.Call(_m, "CreateTapDevice", tapName, pid, isMultiqueue)
	ret0, _ := ret[0].(error)
	return ret0
}
