...
func (_m *MockNetworkHandler) GetAvailableAddrsFromCIDR(s string) ([]string, error) {
	ret := _m.ctrl.Call(_m, "GetAvailableAddrsFromCIDR", s)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockNetworkHandlerRecorder) GetAvailableAddrsFromCIDR(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetAvailableAddrsFromCIDR", arg0)
}
...
func (_m *MockNetworkHandler) GenerateRandomMac() net.HardwareAddr {
