...
func newPodNIC(vmi *v1.VirtualMachineInstance, network *v1.Network, handler netdriver.NetworkHandler, cacheFactory cache.InterfaceCacheFactory, launcherPID *int) (*podNIC, error) {
	podnic, err := newPodNICWithWithoutInfraConfigurator(vmi, network, handler, cacheFactory, launcherPID)
	if err != nil {
		return nil, err
	}
	if podnic.vmiSpecIface.Bridge != nil {
		if podnic.launcherPID != nil {
...
func newPodNICWithWithoutInfraConfigurator(vmi *v1.VirtualMachineInstance, network *v1.Network, handler netdriver.NetworkHandler, cacheFactory cache.InterfaceCacheFactory, launcherPID *int) (*podNIC, error) {
