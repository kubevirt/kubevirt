...
type NetworkHandler interface {
	...
	StartDHCP(nic *VIF, serverAddr *netlink.Addr, bridgeInterfaceName string, name string, namespace string)
}
...
func (h *NetworkUtilsHandler) StartDHCP(nic *VIF, serverAddr *netlink.Addr, bridgeInterfaceName string, name string, namespace string) {
