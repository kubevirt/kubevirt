...
var _ = Describe("Converter", func() {
  ...
  <shareable></shareable>
	...
	Context("with v1.VirtualMachineInstance", func() {
		...
		var convertedDomain = strings.TrimSpace(fmt.Sprintf(embedDomainTemplateX86_64, "kvm", "%s"))
		...
		var convertedDomainppc64le = strings.TrimSpace(fmt.Sprintf(embedDomainTemplatePPC64le, "kvm", "%s"))
		...
		var convertedDomainarm64 = strings.TrimSpace(fmt.Sprintf(embedDomainTemplateARM64, "kvm", "%s"))
		...
		var convertedDomains390x = strings.TrimSpace(fmt.Sprintf(embedDomainTemplateS390X, "kvm", "%s"))
