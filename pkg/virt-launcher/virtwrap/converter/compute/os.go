...
func (o OSDomainConfigurator) Configure(vmi *v1.VirtualMachineInstance, domain *api.Domain) error {
	...
	o.configureMachineType(vmi, domain)
	o.configureBootMenu(vmi, domain)
...
func (o OSDomainConfigurator) configureMachineType(vmi *v1.VirtualMachineInstance, domain *api.Domain) {
	if machine := vmi.Spec.Domain.Machine; machine != nil {
		domain.Spec.OS.Type.Machine = machine.Type
	}
}

func (o OSDomainConfigurator) configureBootMenu(vmi *v1.VirtualMachineInstance, domain *api.Domain) {
...
func (o OSDomainConfigurator) convert_v1_Firmware_To_related_apis(vmi *v1.VirtualMachineInstance, domain *api.Domain) error {
	...
	o.configureBIOS(firmware, domain)
	o.configureKernelBoot(vmi, firmware, domain)

	return o.configureACPI(firmware, domain, vmi.Spec.Volumes)
}
...
func (o OSDomainConfigurator) configureBIOS(firmware *v1.Firmware, domain *api.Domain) {
...
func (o OSDomainConfigurator) configureKernelBoot(vmi *v1.VirtualMachineInstance, firmware *v1.Firmware, domain *api.Domain) {
	if util.HasKernelBootContainerImage(vmi) {
		o.configureKernelBootContainer(vmi, firmware.KernelBoot, domain)
	}
...
func (o OSDomainConfigurator) configureKernelBootContainer(vmi *v1.VirtualMachineInstance, kb *v1.KernelBoot, domain *api.Domain) {
...
func (o OSDomainConfigurator) configureACPI(firmware *v1.Firmware, domain *api.Domain, volumes []v1.Volume) error {
	...
	if err := o.appendACPITable("slic", firmware.ACPI.SlicNameRef, volumes, domain); err != nil {
		return err
	}

	return o.appendACPITable("msdm", firmware.ACPI.MsdmNameRef, volumes, domain)
}

func (o OSDomainConfigurator) appendACPITable(tableType, volumeName string, volumes []v1.Volume, domain *api.Domain) error {
