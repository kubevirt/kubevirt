...
func NewUsbRedirectDeviceDomainConfigurator() UsbRedirectDeviceDomainConfigurator {
	return UsbRedirectDeviceDomainConfigurator{}
}

func (h UsbRedirectDeviceDomainConfigurator) Configure(vmi *v1.VirtualMachineInstance, domain *api.Domain) error {
