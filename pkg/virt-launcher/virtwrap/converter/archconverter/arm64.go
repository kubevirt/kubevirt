...
func (archConverterARM64) AddGraphicsDevice(vmi *v1.VirtualMachineInstance, domain *api.Domain, _ bool) {
...
func (archConverterARM64) ScsiController(model string, driver *api.ControllerDriver) api.Controller {
