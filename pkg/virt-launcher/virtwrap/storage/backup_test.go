...
var _ = Describe("Backup", func() {
	...
	Describe("HandleBackupJobCompletedEvent", func() {
		var event *libvirt.DomainEventJobCompleted
		...
		Context("when backup was aborted", func() {
		...
		Context("when backup job has unexpected type", func() {
		...
		Context("when backup failed", func() {
		...
		Context("when domain is nil", func() {
			It("should still complete the backup", func() {
				manager.HandleBackupJobCompletedEvent(nil, event)
