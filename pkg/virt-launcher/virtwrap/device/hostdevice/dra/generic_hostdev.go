...
func CreateDRAHostDevices(vmi *v1.VirtualMachineInstance) ([]api.HostDevice, error) {
	...
	for _, hd := range vmi.Spec.Domain.Devices.HostDevices {
		...
		hostDevice, err := createHostDeviceForHostDevice(hd, vmi.Spec)
		if err != nil {
...
func createHostDeviceForHostDevice(hd v1.HostDevice, vmiSpecs v1.VirtualMachineInstanceSpec) (*api.HostDevice, error) {
