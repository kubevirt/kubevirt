...
func (e *eventCaller) handleGuestPanicEvent(client *Notifier, vmi *v1.VirtualMachineInstance, metadataCache *metadata.Cache) {
	if vmi == nil {
...
func (e *eventCaller) eventCallback(c cli.Connection, domain *api.Domain, libvirtEvent libvirtEvent, client *Notifier, events chan watch.Event,
	...
	if isGuestPanicEvent(libvirtEvent.Event) {
		e.handleGuestPanicEvent(client, vmi, metadataCache)
	}
