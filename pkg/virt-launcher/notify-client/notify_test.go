	...
	Describe("Domain Events", func() {
		...
		It("should transition StartingUp metadata from true to false when domain becomes running",
			func() {
				...
				e.eventCallback(mockLibvirt.VirtConnection, util.NewDomainFromName("test", "1234"), libvirtEvent{Event: &libvirt.DomainEventLifecycle{Event: libvirt.DOMAIN_EVENT_STARTED}}, client, deleteNotificationSent, nil, nil, nil, nil, cache, false)
