...
func newValidPatchRequest() *http.Request {
	request, _ := http.NewRequest("PATCH", "/apis/kubevirt.io/v1alpha1/namespaces/default/vms/test", nil)
...
var _ = Describe("Patch", func() {
	...
	BeforeEach(func() {
		...
		ws.Route(ws.PATCH("/apis/kubevirt.io/v1alpha1/namespaces/{namespace}/vms/{name}").To(target))
