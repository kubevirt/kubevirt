	...
	Describe("migration proxy", func() {
		Context("verify proxy connections work", func() {
			...
			DescribeTable("by creating both ends with a manager and sending a message", func(migrationConfig *v1.MigrationConfiguration) {
				...
				Entry("with TLS enabled", &v1.MigrationConfiguration{ClusterMigrationConfiguration: v1.ClusterMigrationConfiguration{DisableTLS: pointer.P(false)}}),
				Entry("with TLS disabled", &v1.MigrationConfiguration{ClusterMigrationConfiguration: v1.ClusterMigrationConfiguration{DisableTLS: pointer.P(true)}}),
			)
