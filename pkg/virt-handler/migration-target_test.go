...
type netSocketMigrationTargetStub struct{}

func (n *netSocketMigrationTargetStub) HandleMigrationTarget(*v1.VirtualMachineInstance, func(*v1.VirtualMachineInstance) (string, error)) error {
	return nil
}
