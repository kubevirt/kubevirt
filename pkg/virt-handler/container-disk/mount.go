...
func NewMounter(isoDetector isolation.PodIsolationDetector, mountStateDir, mountStateDirTemp string, clusterConfig *virtconfig.ClusterConfig) Mounter {
	return &mounter{
		mountRecords:               make(map[types.UID]*vmiMountTargetRecord),
		podIsolationDetector:       isoDetector,
		checkpointManager:          checkpoint.NewSimpleCheckpointManager(mountStateDir, mountStateDirTemp),
