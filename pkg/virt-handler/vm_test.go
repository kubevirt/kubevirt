...
var _ = Describe("VirtualMachineInstance", func() {
	...
	Context("VirtualMachineInstance controller gets informed about a Domain change through the Domain controller", func() {
		...
		It("should silently retry if the command socket is not yet ready", func() {
			...
			vmiFeeder.Add(vmi)
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, vmi *v1.VirtualMachineInstance, arg0 interface{}) {
		...
		It("should update the qemu machine type on the VMI status", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).DoAndReturn(func(_ context.Context, obj interface{}, arg0 interface{}) (*v1.VirtualMachineInstance, error) {
		...
		It("should update from Scheduled to Running, if it sees a running Domain", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).DoAndReturn(func(ctx context.Context, obj interface{}, arg0 interface{}) (*v1.VirtualMachineInstance, error) {
				vmi := obj.(*v1.VirtualMachineInstance)
		...
		It("should add guest agent condition when sees the channel connected", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), NewVMICondMatcher(*updatedVMI), metav1.UpdateOptions{})
		...
		It("should update access credential condition if agent disconnects", func() {
			...
			client.EXPECT().SyncVirtualMachine(vmi, gomock.Any())
			vmiInterface.EXPECT().Update(context.Background(), NewVMICondMatcher(*vmiCopy), metav1.UpdateOptions{})
			mockHotplugVolumeMounter.EXPECT().Unmount(gomock.Any(), mockCgroupManager).Return(nil)
			mockHotplugVolumeMounter.EXPECT().Mount(gomock.Any(), mockCgroupManager).Return(nil)
		...
		It("should remove an error condition if a synchronization run succeeds", func() {
			...
			mockHotplugVolumeMounter.EXPECT().Mount(gomock.Any(), mockCgroupManager).Return(nil)
			vmiInterface.EXPECT().Update(context.Background(), updatedVMI, metav1.UpdateOptions{})
		...
		Context("reacting to a VMI with a containerDisk", func() {
			...
			It("should compute checksums for the specified containerDisks and kernelboot containers", func() {
				...
				vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).DoAndReturn(
					func(ctx context.Context, vmi *v1.VirtualMachineInstance, arg0 interface{}) (*v1.VirtualMachineInstance, error) {
		...
		Context("reacting to a VMI with hotplug", func() {
			...
			It("should call mount if VMI is scheduled to run", func() {
				...
				vmi.Status.Phase = v1.Scheduled
				vmiFeeder.Add(vmi)
				vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{})
				mockHotplugVolumeMounter.EXPECT().Mount(gomock.Any(), mockCgroupManager).Return(nil)
				client.EXPECT().SyncVirtualMachine(vmi, gomock.Any())
		...
		It("Handoff domain to other node after completed migration", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), vmiUpdated, metav1.UpdateOptions{})
		...
		It("should apply post-migration operations on guest VM after migration completed", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, vmiObj *v1.VirtualMachineInstance, arg0 interface{}) {
	...
	Context("VirtualMachineInstance controller gets informed about changes in a Domain", func() {
		It("should update Guest OS Information in VMI status", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, arg0, arg1 interface{}) {
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.ID).To(Equal(domain.Status.OSInfo.Id))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.Name).To(Equal(domain.Status.OSInfo.Name))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.PrettyName).To(Equal(domain.Status.OSInfo.PrettyName))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.Version).To(Equal(domain.Status.OSInfo.Version))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.VersionID).To(Equal(domain.Status.OSInfo.VersionId))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.Machine).To(Equal(domain.Status.OSInfo.Machine))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.KernelRelease).To(Equal(domain.Status.OSInfo.KernelRelease))
				Expect(arg0.(*v1.VirtualMachineInstance).Status.GuestOSInfo.KernelVersion).To(Equal(domain.Status.OSInfo.KernelVersion))
			}).Return(vmi, nil)
		...
		It("should update Guest FSFreeze Status in VMI status if fs frozen", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, arg0, arg1 interface{}) {
				Expect(arg0.(*v1.VirtualMachineInstance).Status.FSFreezeStatus).To(Equal(guestFSFreeezeStatus))
			}).Return(vmi, nil)
		...
		It("should not show Guest FSFreeze Status in VMI status if fs not frozen", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, arg0, arg1 interface{}) {
				Expect(arg0.(*v1.VirtualMachineInstance).Status.FSFreezeStatus).To(BeEmpty())
			}).Return(vmi, nil)
		...
		It("should update Memory information in VMI status", func() {
			...
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, arg0, arg1 interface{}) {
				Expect(*(arg0.(*v1.VirtualMachineInstance).Status.Memory.GuestCurrent)).To(Equal(expectedMemory))
			}).Return(vmi, nil)
	...
	Context("VirtualMachineInstance controller gets informed about disk information", func() {
		It("should update existing volume status with target", func() {
			...
			mockHotplugVolumeMounter.EXPECT().Mount(gomock.Any(), mockCgroupManager).Return(nil)
			vmiInterface.EXPECT().Update(context.Background(), gomock.Any(), metav1.UpdateOptions{}).Do(func(ctx context.Context, arg0, arg1 interface{}) {
				Expect(arg0.(*v1.VirtualMachineInstance).Status.VolumeStatus).To(HaveLen(2))
				for _, status := range arg0.(*v1.VirtualMachineInstance).Status.VolumeStatus {
