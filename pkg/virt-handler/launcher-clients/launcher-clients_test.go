...
var _ = Describe("GetVerifiedLauncherClient FindSocket check", func() {
	...
	It("should succeed when Ping succeed", func() {
	...
	It("should succeed when Ping fails but FindSocket succeed", func() {
	...
	It("should fails when both Ping and FindSocket fails", func() {
