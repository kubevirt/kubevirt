...
func (c *MigrationTargetController) processVMI(vmi *v1.VirtualMachineInstance) (error, bool) {
	...
	if c.pluginExecutor != nil {
		if err := c.pluginExecutor.CallNodeHooks(pluginv1alpha1.NodeHookPreMigrationTarget, vmi); err != nil {
			return err, false
		}
	}
...
func (c *MigrationTargetController) finalizeMigration(vmi *v1.VirtualMachineInstance) error {
	...
	if c.pluginExecutor != nil {
		if err := c.pluginExecutor.CallNodeHooks(pluginv1alpha1.NodeHookPostMigrationTarget, vmi); err != nil {
			return err
		}
	}
