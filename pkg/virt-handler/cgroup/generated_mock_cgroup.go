...
func (_m *MockManager) CreateChildCgroup(name string, subSystems ...string) (Manager, error) {
	_s := []interface{}{name}
	for _, _x := range subSystems {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "CreateChildCgroup", _s...)
	ret0, _ := ret[0].(Manager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockManagerRecorder) CreateChildCgroup(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0}, arg1...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateChildCgroup", _s...)
}
...
func (_m *MockManager) InitializeEmulatorContainer(vmi *v1.VirtualMachineInstance) error {
	ret := _m.ctrl.Call(_m, "InitializeEmulatorContainer", vmi)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) InitializeEmulatorContainer(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "InitializeEmulatorContainer", arg0)
}
