...
func (a defaultArchLabeller) ShouldLabelNodes() bool {
	return false
}

func (a defaultArchLabeller) defaultVendor() string {
	return ""
}

func (a defaultArchLabeller) requirePolicy(policy string) bool {
	return policy == util.RequirePolicy
}

func (a defaultArchLabeller) hasHostSupportedFeatures() bool {
	return false
}

func (a defaultArchLabeller) supportsHostModel() bool {
	return false
}
