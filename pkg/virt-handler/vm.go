...
func NewController(
	...
	c.deviceManagerController = device_manager.NewDeviceController(
		...
		clusterConfig,
		clientset.CoreV1())
	c.heartBeat = heartbeat.NewHeartBeat(clientset.CoreV1().Nodes(), clientset.ShadowNodeClient(), clientset.AuthorizationV1(), c.deviceManagerController, clusterConfig, host)
