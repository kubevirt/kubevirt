...
func NewController(
	...
	c := &VirtualMachineController{
		...
		sriovHotplugExecutorPool:    executor.NewRateLimitedExecutorPool(executor.NewExponentialLimitedBackoffCreator(executor.NewDefaultBackoff(), executor.DefaultMaxStep)),
	}
