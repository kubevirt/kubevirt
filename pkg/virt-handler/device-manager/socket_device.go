...
func (dpi *SocketDevicePlugin) setSocketDirectoryPermissions() error {
	...
	err = safepath.ChownAtNoFollow(dir, util.NonRootUID, util.NonRootUID)
	if err != nil {
...
func NewSocketDevicePlugin(socketName, socketDir, socket string, maxDevices int, executor selinux.Executor) (*SocketDevicePlugin, error) {
