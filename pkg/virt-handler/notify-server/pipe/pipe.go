...
// Proxy is blocking, it proxies pipe connection [pipeConn] to given connection [connect](ultimetly to notify server)
// pipeConn is closed on success or error
func Proxy(logger *log.FilteredLogger, pipeConn net.Conn, connect connectF) {
