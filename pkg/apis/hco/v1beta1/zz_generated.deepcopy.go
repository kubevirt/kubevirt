...
func (in *CertRotateConfig) DeepCopyInto(out *CertRotateConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertRotateConfig.
func (in *CertRotateConfig) DeepCopy() *CertRotateConfig {
	if in == nil {
		return nil
	}
	out := new(CertRotateConfig)
	in.DeepCopyInto(out)
	return out
}
