...
// ExampleV1Client is used to interact with features provided by the example.test.apiserver.code-generator.k8s.io group.
type ExampleV1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1Client) NetworkAttachmentDefinitions(namespace string) NetworkAttachmentDefinitionInterface {
