...
var packagemanifestsResource = schema.GroupVersionResource{Group: "apps.redhat.com", Version: "v1alpha1", Resource: "packagemanifests"}

var packagemanifestsKind = schema.GroupVersionKind{Group: "apps.redhat.com", Version: "v1alpha1", Kind: "PackageManifest"}
...
func (c *FakePackageManifests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PackageManifest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(packagemanifestsResource, c.ns, name, pt, data, subresources...), &v1alpha1.PackageManifest{})
