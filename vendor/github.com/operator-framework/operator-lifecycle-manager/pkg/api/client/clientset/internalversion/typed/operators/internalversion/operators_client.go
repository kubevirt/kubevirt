...
import (
	"github.com/operator-framework/operator-lifecycle-manager/pkg/api/client/clientset/internalversion/scheme"
...
func (c *OperatorsClient) CatalogSources(namespace string) CatalogSourceInterface {
	return newCatalogSources(c, namespace)
}

func (c *OperatorsClient) ClusterServiceVersions(namespace string) ClusterServiceVersionInterface {
	return newClusterServiceVersions(c, namespace)
}

func (c *OperatorsClient) InstallPlans(namespace string) InstallPlanInterface {
	return newInstallPlans(c, namespace)
}

func (c *OperatorsClient) OperatorGroups(namespace string) OperatorGroupInterface {
	return newOperatorGroups(c, namespace)
}

func (c *OperatorsClient) Subscriptions(namespace string) SubscriptionInterface {
