...
import (
	operatorsinternalversion "github.com/operator-framework/operator-lifecycle-manager/pkg/api/client/clientset/internalversion/typed/operators/internalversion"
