...
type OperatorGroupLister interface {
	...
	List(selector labels.Selector) (ret []*operators.OperatorGroup, err error)
...
// List lists all OperatorGroups in the indexer.
func (s *operatorGroupLister) List(selector labels.Selector) (ret []*operators.OperatorGroup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*operators.OperatorGroup))
	})
	return ret, err
}
...
type OperatorGroupNamespaceLister interface {
	...
	Get(name string) (*operators.OperatorGroup, error)
...
// List lists all OperatorGroups in the indexer for a given namespace.
func (s operatorGroupNamespaceLister) List(selector labels.Selector) (ret []*operators.OperatorGroup, err error) {
...
// Get retrieves the OperatorGroup from the indexer for a given namespace and name.
func (s operatorGroupNamespaceLister) Get(name string) (*operators.OperatorGroup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(operators.Resource("operatorgroup"), name)
	}
	return obj.(*operators.OperatorGroup), nil
}
