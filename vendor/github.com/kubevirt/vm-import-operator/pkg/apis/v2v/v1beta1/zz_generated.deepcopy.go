...
func (in *VirtualMachineImportSpec) DeepCopyInto(out *VirtualMachineImportSpec) {
	*out = *in
	...
	in.Source.DeepCopyInto(&out.Source)
	if in.FinalizeDate != nil {
		in, out := &in.FinalizeDate, &out.FinalizeDate
		*out = (*in).DeepCopy()
	}
...
func (in *VirtualMachineImportStatus) DeepCopyInto(out *VirtualMachineImportStatus) {
	*out = *in
	...
	in.WarmImport.DeepCopyInto(&out.WarmImport)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineWarmImportStatus) DeepCopyInto(out *VirtualMachineWarmImportStatus) {
	*out = *in
	if in.NextStageTime != nil {
		in, out := &in.NextStageTime, &out.NextStageTime
		*out = (*in).DeepCopy()
	}
	if in.RootSnapshot != nil {
		in, out := &in.RootSnapshot, &out.RootSnapshot
		*out = new(string)
		**out = **in
	}
	return
...
func (in *VirtualMachineWarmImportStatus) DeepCopy() *VirtualMachineWarmImportStatus {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineWarmImportStatus)
	in.DeepCopyInto(out)
	return out
}
