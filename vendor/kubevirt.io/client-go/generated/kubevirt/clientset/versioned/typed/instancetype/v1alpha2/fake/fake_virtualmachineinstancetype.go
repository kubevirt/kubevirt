...
var virtualmachineinstancetypesResource = schema.GroupVersionResource{Group: "instancetype.kubevirt.io", Version: "v1alpha2", Resource: "virtualmachineinstancetypes"}

var virtualmachineinstancetypesKind = schema.GroupVersionKind{Group: "instancetype.kubevirt.io", Version: "v1alpha2", Kind: "VirtualMachineInstancetype"}
...
func (c *FakeVirtualMachineInstancetypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineInstancetype, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(virtualmachineinstancetypesResource, c.ns, name), &v1alpha2.VirtualMachineInstancetype{})
...
func (c *FakeVirtualMachineInstancetypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineInstancetypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(virtualmachineinstancetypesResource, virtualmachineinstancetypesKind, c.ns, opts), &v1alpha2.VirtualMachineInstancetypeList{})
...
func (c *FakeVirtualMachineInstancetypes) Create(ctx context.Context, virtualMachineInstancetype *v1alpha2.VirtualMachineInstancetype, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineInstancetype, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(virtualmachineinstancetypesResource, c.ns, virtualMachineInstancetype), &v1alpha2.VirtualMachineInstancetype{})
...
func (c *FakeVirtualMachineInstancetypes) Update(ctx context.Context, virtualMachineInstancetype *v1alpha2.VirtualMachineInstancetype, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineInstancetype, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(virtualmachineinstancetypesResource, c.ns, virtualMachineInstancetype), &v1alpha2.VirtualMachineInstancetype{})
...
func (c *FakeVirtualMachineInstancetypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(virtualmachineinstancetypesResource, c.ns, name), &v1alpha2.VirtualMachineInstancetype{})
...
func (c *FakeVirtualMachineInstancetypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineInstancetype, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(virtualmachineinstancetypesResource, c.ns, name, pt, data, subresources...), &v1alpha2.VirtualMachineInstancetype{})
