...
var virtualmachinesnapshotcontentsResource = schema.GroupVersionResource{Group: "snapshot.kubevirt.io", Version: "v1beta1", Resource: "virtualmachinesnapshotcontents"}

var virtualmachinesnapshotcontentsKind = schema.GroupVersionKind{Group: "snapshot.kubevirt.io", Version: "v1beta1", Kind: "VirtualMachineSnapshotContent"}
...
func (c *FakeVirtualMachineSnapshotContents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VirtualMachineSnapshotContent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(virtualmachinesnapshotcontentsResource, c.ns, name), &v1beta1.VirtualMachineSnapshotContent{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VirtualMachineSnapshotContent), err
}
...
func (c *FakeVirtualMachineSnapshotContents) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VirtualMachineSnapshotContentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(virtualmachinesnapshotcontentsResource, virtualmachinesnapshotcontentsKind, c.ns, opts), &v1beta1.VirtualMachineSnapshotContentList{})
	...
	list := &v1beta1.VirtualMachineSnapshotContentList{ListMeta: obj.(*v1beta1.VirtualMachineSnapshotContentList).ListMeta}
	for _, item := range obj.(*v1beta1.VirtualMachineSnapshotContentList).Items {
...
func (c *FakeVirtualMachineSnapshotContents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(virtualmachinesnapshotcontentsResource, c.ns, opts))
...
func (c *FakeVirtualMachineSnapshotContents) Create(ctx context.Context, virtualMachineSnapshotContent *v1beta1.VirtualMachineSnapshotContent, opts v1.CreateOptions) (result *v1beta1.VirtualMachineSnapshotContent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(virtualmachinesnapshotcontentsResource, c.ns, virtualMachineSnapshotContent), &v1beta1.VirtualMachineSnapshotContent{})
...
func (c *FakeVirtualMachineSnapshotContents) Update(ctx context.Context, virtualMachineSnapshotContent *v1beta1.VirtualMachineSnapshotContent, opts v1.UpdateOptions) (result *v1beta1.VirtualMachineSnapshotContent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(virtualmachinesnapshotcontentsResource, c.ns, virtualMachineSnapshotContent), &v1beta1.VirtualMachineSnapshotContent{})
...
func (c *FakeVirtualMachineSnapshotContents) UpdateStatus(ctx context.Context, virtualMachineSnapshotContent *v1beta1.VirtualMachineSnapshotContent, opts v1.UpdateOptions) (*v1beta1.VirtualMachineSnapshotContent, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(virtualmachinesnapshotcontentsResource, "status", c.ns, virtualMachineSnapshotContent), &v1beta1.VirtualMachineSnapshotContent{})
...
func (c *FakeVirtualMachineSnapshotContents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(virtualmachinesnapshotcontentsResource, c.ns, name), &v1beta1.VirtualMachineSnapshotContent{})
...
func (c *FakeVirtualMachineSnapshotContents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(virtualmachinesnapshotcontentsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.VirtualMachineSnapshotContentList{})
	return err
}
...
func (c *FakeVirtualMachineSnapshotContents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VirtualMachineSnapshotContent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(virtualmachinesnapshotcontentsResource, c.ns, name, pt, data, subresources...), &v1beta1.VirtualMachineSnapshotContent{})
