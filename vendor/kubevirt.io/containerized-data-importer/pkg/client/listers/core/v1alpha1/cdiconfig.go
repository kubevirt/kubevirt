...
// List lists all CDIConfigs in the indexer.
func (s *cDIConfigLister) List(selector labels.Selector) (ret []*v1alpha1.CDIConfig, err error) {
...
func (s *cDIConfigLister) Get(name string) (*v1alpha1.CDIConfig, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cdiconfig"), name)
	}
	return obj.(*v1alpha1.CDIConfig), nil
}
