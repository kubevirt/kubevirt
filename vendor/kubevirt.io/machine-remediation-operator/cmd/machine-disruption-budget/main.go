...
func main() {
	namespace := flag.String("namespace", "", "Namespace that the controller watches to reconcile objects. If unspecified, the controller watches for machine-disruption-budget objects across all namespaces.")
	flag.Parse()
