...
rpm(
    name = "glibc-langpack-es-0__2.34-245.el9.s390x",
    sha256 = "3c791708506441718c78fd7139d704e974c500abff4738a5c24c5ab56e5d2ef0",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/s390x/os/Packages/glibc-langpack-es-2.34-245.el9.s390x.rpm",
    ],
)
