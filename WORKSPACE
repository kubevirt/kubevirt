...
rpm(
    name = "glibc-langpack-el-0__2.34-244.el9.aarch64",
    sha256 = "b305dae6531656b1429fc40d4aa29d5e073281b09ef707880fd50890fb524286",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-langpack-el-2.34-244.el9.aarch64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-eo-0__2.34-244.el9.s390x",
    sha256 = "afeb52831218e865d0cee6e0a4605dccb75feaa8d5f3558af25d4c6c111131f4",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/s390x/os/Packages/glibc-langpack-eo-2.34-244.el9.s390x.rpm",
    ],
)

rpm(
    name = "glibc-langpack-gu-0__2.34-244.el9.x86_64",
    sha256 = "5409cf4155fbb164e26ae2e606ea7f551607623b0a9ff8bea595336988be0c6d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-langpack-gu-2.34-244.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-img-17__10.1.0-4.el9.aarch64",
    sha256 = "f621cb058d377dcc2c9ab72fddb8b2af4b6cad8f43227815b3bbf1143d30126b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-img-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-img-17__10.1.0-4.el9.s390x",
    sha256 = "97d676a45058bcb22bb27d51fc8608c75fccb4ccf37cf5ab4f60688bbb581b80",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-img-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-img-17__10.1.0-4.el9.x86_64",
    sha256 = "f7c28aaebc376d4c2ca380dc83291db11900a1bc63c737f9d432281b29a1af9a",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-img-10.1.0-4.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-common-17__10.1.0-4.el9.aarch64",
    sha256 = "c823965ccdba5146fe9dd5ffc858d4cba11cbb43445d59532cfaea1b85a648b8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-common-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__10.1.0-4.el9.s390x",
    sha256 = "e03c4bf7bb060ff5887f57d90b60b956acfe2cfd30877c9f335db709fdf3be0f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-common-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__10.1.0-4.el9.x86_64",
    sha256 = "b7a9190aed19b9a259c03065dc978ff7b8ea4fa57f0ed61b09e21f8d5dbab167",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-common-10.1.0-4.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-core-17__10.1.0-4.el9.aarch64",
    sha256 = "9e92b4e92a3c5d79a395ef71dbc294891da63ca1c31caf1dc22bf4fd3c61a268",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-core-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__10.1.0-4.el9.s390x",
    sha256 = "f31dc05f6087d7592819fee7a89868400b73c479d9ac3635581f77d708739de3",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-core-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__10.1.0-4.el9.x86_64",
    sha256 = "73193fdce1cf2d536f30da246ccc471014f97bd0ee661fece8ea4e9d617231cb",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-core-10.1.0-4.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-4.el9.aarch64",
    sha256 = "797cd5e967a12b614303fdfaa5b1acd504cc686a2349c26df77025736ec8f924",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-4.el9.s390x",
    sha256 = "4c4f86a291ab4e62387f7a570ed7cb14de7f5d91799c4a0c9fdd3f531264dfd2",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-4.el9.x86_64",
    sha256 = "34383d707b2f7292ec15c3108ee504d0028b8619d7983fc335ddc4dda0f60627",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-4.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-ccw-17__10.1.0-4.el9.s390x",
    sha256 = "632912a7b2ee1c1c1267595c6f5bab420a6af5233c23dfa82833f2c8e337376d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-display-virtio-gpu-ccw-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-pci-17__10.1.0-4.el9.aarch64",
    sha256 = "83286d15f083ba5a39cbf976d3f4f382c79f9c0f77e3bfe1d8fb9a8438f5d83b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-pci-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-pci-17__10.1.0-4.el9.x86_64",
    sha256 = "8469881205afc995a9617a1b7217c38a430412b2839729444321aeec19b11617",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-gpu-pci-10.1.0-4.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-vga-17__10.1.0-4.el9.x86_64",
    sha256 = "b690b3a21e4510bf48a5cfe6fe658167baf98a7c51c5b7bab3fb4e87b1d3e468",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-vga-10.1.0-4.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-4.el9.aarch64",
    sha256 = "70ad311004ed1d5634bc80872d2c668f35c200401018065dc11d85d57b903b4f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-usb-host-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-4.el9.s390x",
    sha256 = "6a39c04cae2d061c4bf6f78d38a65fb754045db7d9507f17768f406873103c04",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-usb-host-10.1.0-4.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-4.el9.x86_64",
    sha256 = "3ac5b20aeae0014f8ea2eb02a4643ffda3ecb921ffbde4eac28a18d21110b85e",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-usb-host-10.1.0-4.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-redirect-17__10.1.0-4.el9.aarch64",
    sha256 = "558128a9845c321283333f3386a27fa483ba965fc4ab1529ed5e5016f199f54c",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-usb-redirect-10.1.0-4.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-redirect-17__10.1.0-4.el9.x86_64",
    sha256 = "1252731b7476ccfd6caa492e7c442266c3ca6c7b87dbd2d711ec01056f3a655f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-usb-redirect-10.1.0-4.el9.x86_64.rpm",
    ],
)
