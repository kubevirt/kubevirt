...
rpm(
    name = "glibc-langpack-el-0__2.34-262.el9.x86_64",
    sha256 = "3398d5c93af0524ef0e681af454f6c50572e8b561bd494bfebbb74e4fdea4cee",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-langpack-el-2.34-262.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "glibc-langpack-et-0__2.34-262.el9.s390x",
    sha256 = "1bbbbd9408ff0db2122ddb9f7b44bcb89c7cd5561b2b0c47309aba8042639479",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/s390x/os/Packages/glibc-langpack-et-2.34-262.el9.s390x.rpm",
    ],
)
...
rpm(
    name = "glibc-langpack-gez-0__2.34-262.el9.aarch64",
    sha256 = "d44f1ad32aa72b505d1a7136605faed760282ac3be4ba2e9f37f7c1d895c72a6",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-langpack-gez-2.34-262.el9.aarch64.rpm",
    ],
)
...
rpm(
    name = "kernel-headers-0__5.14.0-689.el9.aarch64",
    sha256 = "961dd258797983cfe222e14bb522efe802fe170f77525f95742eaddff4e20c1c",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/kernel-headers-5.14.0-689.el9.aarch64.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-689.el9.s390x",
    sha256 = "bf93f6a1eb99443dabebcc14939f1fa1b7bc2da86769fe5073bdb7d40854c2ab",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/kernel-headers-5.14.0-689.el9.s390x.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-689.el9.x86_64",
    sha256 = "e8788f860dd42409f3f6ba7ab579ded236f335be389deda27f45e87195994c39",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/kernel-headers-5.14.0-689.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-pr-helper-17__10.1.0-17.el9.aarch64",
    sha256 = "70c9da66be158b303b19eedcf116b8e00dfe98db3e50b3d85fb74b32b88e5a0e",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-pr-helper-10.1.0-17.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-pr-helper-17__10.1.0-17.el9.x86_64",
    sha256 = "6f8bdc5f2a9aa9432a6fc8164a197f1ff43a74c162e2c4fa03c5c6f121d9c43b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-pr-helper-10.1.0-17.el9.x86_64.rpm",
    ],
)
