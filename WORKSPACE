...
rpm(
    name = "glibc-langpack-eu-0__2.39-124.el10.aarch64",
    sha256 = "df899520e18d0d6103a357fd334728a9492942e752181b7e2e72c8d6fa3086b9",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/aarch64/os/Packages/glibc-langpack-eu-2.39-124.el10.aarch64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-fil-0__2.39-124.el10.x86_64",
    sha256 = "89e3bb1834764bb59f2abbf28f2846f547bfb4e809b4aeab6200e2aae0e87d2f",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/x86_64/os/Packages/glibc-langpack-fil-2.39-124.el10.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-fo-0__2.39-124.el10.s390x",
    sha256 = "6c11a6913a2b413590e85dc56772c028dd35f175060ef171584ee71fe7aabe35",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/s390x/os/Packages/glibc-langpack-fo-2.39-124.el10.s390x.rpm",
    ],
)
