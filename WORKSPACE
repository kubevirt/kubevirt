...
rpm(
    name = "kernel-headers-0__5.14.0-617.el9.aarch64",
    sha256 = "0f118eeca9c67ad5d9b528502541a37896a76f9ba42dc01195284f43912890fc",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/kernel-headers-5.14.0-617.el9.aarch64.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-617.el9.s390x",
    sha256 = "37b27fa145a974457771bdc4e6d48309827c58e6a20490700e5ef760a9438fd4",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/kernel-headers-5.14.0-617.el9.s390x.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-617.el9.x86_64",
    sha256 = "8dc4c726537d55bc412733027802d0a0ef57368da044b574f2c921e3b95f6508",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/kernel-headers-5.14.0-617.el9.x86_64.rpm",
    ],
)
