...
rpm(
    name = "glibc-langpack-el-0__2.34-245.el9.aarch64",
    sha256 = "eec76288ac3571903f1ae51d41caa7cde8c0d663b455557df98383e34a959dfd",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-langpack-el-2.34-245.el9.aarch64.rpm",
    ],
)
