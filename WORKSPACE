...
rpm(
    name = "glibc-langpack-el-0__2.34-245.el9.s390x",
    sha256 = "af6ad78bfe291298b012dd6c1791bb9cae32a56feff8ad66e454d9f4faa5a875",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/s390x/os/Packages/glibc-langpack-el-2.34-245.el9.s390x.rpm",
    ],
)

rpm(
    name = "glibc-langpack-es-0__2.34-245.el9.x86_64",
    sha256 = "b1f140743ec945ed64b58fd8df2356d3486e9bf279cbdf9272d1f3ed99021a55",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-langpack-es-2.34-245.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "kernel-headers-0__5.14.0-651.el9.aarch64",
    sha256 = "a36764cd5c457fc0b5530f3d52ee612df62a26758c24600a1c6ec7d5664ead7a",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/kernel-headers-5.14.0-651.el9.aarch64.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-651.el9.s390x",
    sha256 = "249ed5406c926510cb2e98613d4d385882d4d4442a4dbd93f662e233b060954f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/kernel-headers-5.14.0-651.el9.s390x.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-651.el9.x86_64",
    sha256 = "e48e4858686c81dc7af2a369f0d4e991447f1a91d59e879318ff264045e66d7a",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/kernel-headers-5.14.0-651.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-common-17__10.1.0-9.el9.aarch64",
    sha256 = "baa0efe34f48c5a0bfb1ff5407f601dc27a745c622aec79485e159475c92d2f0",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-common-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__10.1.0-9.el9.s390x",
    sha256 = "824eb2d4f504daa0a6d1f6f994eed4b184ee1a87afe2f177935443bf24219a45",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-common-10.1.0-9.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__10.1.0-9.el9.x86_64",
    sha256 = "2474456a55f2ab928619001345aa07c188154fe7ae8e754efb00243dcfb831b9",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-common-10.1.0-9.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-core-17__10.1.0-9.el9.aarch64",
    sha256 = "9e36de90678ca0beb4da740ec20c307584345ee6cc5f5d7837279b4a0719e010",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-core-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__10.1.0-9.el9.s390x",
    sha256 = "14086bf883ea1af49bb8fae3e49b408339442f7da2567e339b713ba7f79e14c0",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-core-10.1.0-9.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__10.1.0-9.el9.x86_64",
    sha256 = "8df7ded9153c111d11eb1de06703bb4e6963de81dce57175e5a382fc36b9e4fd",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-core-10.1.0-9.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-9.el9.aarch64",
    sha256 = "a6cc56560b6bed7710ded3abb84e8eb3952f122dc480a7a31a3dc0fad253e6bd",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-9.el9.s390x",
    sha256 = "62168254cb7cd3da9b0f45747986e62586163f270fcc8a146e750caf132be7e3",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-9.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__10.1.0-9.el9.x86_64",
    sha256 = "329442d6e256286b8218f75a9ca38ebf0a53d001b24a625486b91fde1fed25e5",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-gpu-10.1.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-ccw-17__10.1.0-9.el9.s390x",
    sha256 = "743ede157dcd4f8616a82920c2fffc748135291c52e649edb24cf8356fd160c6",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-display-virtio-gpu-ccw-10.1.0-9.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-pci-17__10.1.0-9.el9.aarch64",
    sha256 = "3901350281983f44cdf5d124b0f9a05f1afb7aef0ac9c2da6c948fd351b74363",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-pci-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-pci-17__10.1.0-9.el9.x86_64",
    sha256 = "3dd3bec096959e183fd7b89fb2bac5aa2ede12659a43f06f43c8f69928ddd232",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-gpu-pci-10.1.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-vga-17__10.1.0-9.el9.x86_64",
    sha256 = "53e3a6c7a9742fa84a08ed06611e7cc2490638954e90860d4d348bf6861c7e7e",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-display-virtio-vga-10.1.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-9.el9.aarch64",
    sha256 = "f24ec9aa01885ab04c17255974432d7ba42de79ed811e752284d97473b40ec2a",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-usb-host-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-9.el9.s390x",
    sha256 = "d0d76aef2fdc5da4caede43ea1ed5ef15006b1b0e70b5dd043af259664904d4f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/qemu-kvm-device-usb-host-10.1.0-9.el9.s390x.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-host-17__10.1.0-9.el9.x86_64",
    sha256 = "dc60679bf2036df3b9f1dcef62698445a88b055fb4573a97fb5960815efe1bc5",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-usb-host-10.1.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-redirect-17__10.1.0-9.el9.aarch64",
    sha256 = "4140d98da040a6a64d256e22556b9bde71c2763762ca0b1580c41920bb9569d5",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-usb-redirect-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-redirect-17__10.1.0-9.el9.x86_64",
    sha256 = "4356b1407ea0cd802c9a2d69e8c2bd011028d6382998428372763bb9a16592b0",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-usb-redirect-10.1.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-pr-helper-17__10.1.0-9.el9.aarch64",
    sha256 = "f0503e60258859d58671bc7f04de14378f60ba2ed1a85e0d8fcc50632101d97d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-pr-helper-10.1.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-pr-helper-17__10.1.0-9.el9.x86_64",
    sha256 = "d6c2b94e191ad8f9fe7ca7d610795af2c41fdff706752ff2d8079335ecea88d5",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-pr-helper-10.1.0-9.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "virtiofsd-0__1.13.2-1.el9.aarch64",
    sha256 = "c48c438d250d13b9aff1d525b07d26266e17dc47dc134404a3f49717f14b2d32",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/virtiofsd-1.13.2-1.el9.aarch64.rpm",
    ],
)

rpm(
    name = "virtiofsd-0__1.13.2-1.el9.s390x",
    sha256 = "f55ce99314e1ccff9eecd69cd9eb1846cc3e4f707b587f733efb991b36bb011b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/s390x/os/Packages/virtiofsd-1.13.2-1.el9.s390x.rpm",
    ],
)

rpm(
    name = "virtiofsd-0__1.13.2-1.el9.x86_64",
    sha256 = "8719ae4c258f08f227051c6e65a5c4c739307abe67333a360cb473f0103fb4a6",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/virtiofsd-1.13.2-1.el9.x86_64.rpm",
    ],
)
