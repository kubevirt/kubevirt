...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/centos-gpg-keys-9.0-22.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/centos-stream-release-9.0-22.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/centos-stream-repos-9.0-22.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "7e4dd1c125f31fb0256973034baa6b7ee6ce7ecad86d5b1d003ed416f710af25",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/cpp-11.4.1-2.1.el9.aarch64.rpm",
    ],
)

rpm(
    name = "cpp-0__11.4.1-2.1.el9.x86_64",
    sha256 = "3dbb972096310a4f0227ecc007a42d9c922bcb2c8bddc2d070a68cc5627e15ea",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/cpp-11.4.1-2.1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/crypto-policies-20230731-1.git94f0e2c.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "c210b20f244bb840cb182e2e4c2887ac5b2a54a95a6e628537cde96f90e5326b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/crypto-policies-20230731-1.git94f0e2c.el9.noarch.rpm",
    ],
)

rpm(
    name = "curl-minimal-0__7.76.1-26.el9.aarch64",
    sha256 = "2e8c9d745dfc03bf7d1252f965f08ec9453ef2172f5a527ef1f8eae2854c88e4",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/curl-minimal-7.76.1-26.el9.aarch64.rpm",
    ],
)

rpm(
    name = "curl-minimal-0__7.76.1-26.el9.x86_64",
    sha256 = "12875d26f40eb5d5f2ff485729386b9c4886c4d32dec9097c3a1bdf8bae0d06f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/curl-minimal-7.76.1-26.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "edk2-aarch64-0__20230524-2.el9.aarch64",
    sha256 = "3c5afc94d906fa12992463eb36bb98a1ebb5db14691dc23f888174e98d9aa45f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/edk2-aarch64-20230524-2.el9.noarch.rpm",
    ],
)

rpm(
    name = "edk2-ovmf-0__20230524-2.el9.x86_64",
    sha256 = "6b70b7559de313e386b316d8fe7206aa9efbb01e930496252c208e9ebde71ab8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/edk2-ovmf-20230524-2.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "faf700a152817a7b4663b52cd2bad6299efe79aee1ff157d055c0c6795214240",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/gcc-11.4.1-2.1.el9.aarch64.rpm",
    ],
)

rpm(
    name = "gcc-0__11.4.1-2.1.el9.x86_64",
    sha256 = "37d116d9588806004fde195b5a3141ac00c009d3e99bae340aee723e188b52d6",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/gcc-11.4.1-2.1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-2.34-82.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-2.34-82.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-common-2.34-82.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-common-2.34-82.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-devel-0__2.34-82.el9.aarch64",
    sha256 = "70fcbcd5baabacda9782b3b96eb3ef487f7857f7893a966750661a505db8e983",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/glibc-devel-2.34-82.el9.aarch64.rpm",
    ],
)

rpm(
    name = "glibc-devel-0__2.34-82.el9.x86_64",
    sha256 = "6f0911a6532a5817daf6629a0947acee48ee2b4fd742bf4d4e2f1cb169d2ce0d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/glibc-devel-2.34-82.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-headers-0__2.34-82.el9.x86_64",
    sha256 = "eba586dd7b6af627783f4c2828d3359b922640165e87165d7cb99be2216899f5",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/glibc-headers-2.34-82.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-hif-0__2.34-82.el9.x86_64",
    sha256 = "91aef1a1568686ddbb011b95ff0d8759fa4bb7c0b7c0a91f5fb7fa89a3f3a28b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-langpack-hif-2.34-82.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-sgs-0__2.34-82.el9.aarch64",
    sha256 = "3dc43e6260d9e37ed74cc47e3897b3e26effebe5ba15b183f2cb493095cb3cae",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-langpack-sgs-2.34-82.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-minimal-langpack-2.34-82.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-minimal-langpack-2.34-82.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-static-0__2.34-82.el9.aarch64",
    sha256 = "17f6c1f4ad704b90118942693935e81333ee39893a9638c249bb92134616470c",
    urls = [
        "http://mirror.stream.centos.org/9-stream/CRB/aarch64/os/Packages/glibc-static-2.34-82.el9.aarch64.rpm",
    ],
)

rpm(
    name = "glibc-static-0__2.34-82.el9.x86_64",
    sha256 = "b177a60c8f3cc954f8bc6c2e3dd64fb6f54d6a0edebd632d5542b8829e851509",
    urls = [
        "http://mirror.stream.centos.org/9-stream/CRB/x86_64/os/Packages/glibc-static-2.34-82.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "kernel-headers-0__5.14.0-361.el9.aarch64",
    sha256 = "89eddad51ae23559ccf55ec913dccf818a621cda4da5cf1467cc129fef90a37f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/kernel-headers-5.14.0-361.el9.aarch64.rpm",
    ],
)

rpm(
    name = "kernel-headers-0__5.14.0-361.el9.x86_64",
    sha256 = "d3b32b99d97d167c65f467096271a10b5056e44d80a8203ed4154f1728a979be",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/kernel-headers-5.14.0-361.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "e49ab0ce02c0f3aa0d47f4f335c51dca8b61e949da783e6373ffee3dbc708b8b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libasan-11.4.1-2.1.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "caf42fa06c699667381d2766d2f89437c8a75068ab30b3c02d791ee063202b98",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libatomic-11.4.1-2.1.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libcurl-minimal-7.76.1-26.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libcurl-minimal-7.76.1-26.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libgcc-11.4.1-2.1.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libgcc-11.4.1-2.1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "4b132977095a64bad968b71aa24b377422b07670642e510d51125bc38f81cb03",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libgomp-11.4.1-2.1.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libgomp-0__11.4.1-2.1.el9.x86_64",
    sha256 = "31c9f4c408f086553932890a77fc6db39b2e42b7977ad22801f60d56e8753101",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libgomp-11.4.1-2.1.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "libsss_idmap-0__2.9.1-2.el9.aarch64",
    sha256 = "af975a93efb2fb50895d7e5da4efb8197c816c2942fcdd1cadf641fc12edcb2b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libsss_idmap-2.9.1-2.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libsss_idmap-0__2.9.1-2.el9.x86_64",
    sha256 = "7c9c6762fa78237b18bc2293fdd9b3a3f3c20f41489ad6bb3b2e62af642d1812",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libsss_idmap-2.9.1-2.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libsss_nss_idmap-0__2.9.1-2.el9.aarch64",
    sha256 = "3e5ac7345cff8391a81556041fdf3f79113c946bdd7eaff8182116e500b465a7",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libsss_nss_idmap-2.9.1-2.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libsss_nss_idmap-0__2.9.1-2.el9.x86_64",
    sha256 = "4f1d2ea1d26d751e80781cbea244816d9df555074cf388cbbda380761c47e43d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libsss_nss_idmap-2.9.1-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libstdc++-11.4.1-2.1.el9.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libstdc++-11.4.1-2.1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "bc7c23c661bff29d61e515f3921496354cc06be546715c17ec63853fca32f08f",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libubsan-11.4.1-2.1.el9.aarch64.rpm",
    ],
)
...
rpm(
    name = "libvirt-client-0__9.5.0-5.el9.aarch64",
    sha256 = "4dfc54be517acb3c02f6ffef25ced866e78db1e51059e94b872b3527de8c5655",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libvirt-client-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-client-0__9.5.0-5.el9.x86_64",
    sha256 = "6d36e2d81de987bf8f0e921df9d31ec6ee0d5952817a9508eab8e6b90983a1c8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-client-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-common-0__9.5.0-5.el9.aarch64",
    sha256 = "a9451936e5a23e974da34a531e31e8d2043b4df27bc83632a2feacb636c262b8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libvirt-daemon-common-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-common-0__9.5.0-5.el9.x86_64",
    sha256 = "90031a58bbe7bb27aebf781c5264889c14e7fdf334793898418385d84971f84e",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-daemon-common-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-driver-qemu-0__9.5.0-5.el9.aarch64",
    sha256 = "4c1cbe9566f49589d52074c2d38f0beac641e89f5c7347ae006615a001b13c17",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libvirt-daemon-driver-qemu-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-driver-qemu-0__9.5.0-5.el9.x86_64",
    sha256 = "f17543311d837a86a27a6f59a4a4e2868a0a248ba3df225dd886af250096b2eb",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-daemon-driver-qemu-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-driver-secret-0__9.5.0-5.el9.x86_64",
    sha256 = "72b5a88ba14056cf401ae61e23576b892b836b34c65c6fc2ebb526d7baaec120",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-daemon-driver-secret-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-driver-storage-core-0__9.5.0-5.el9.x86_64",
    sha256 = "2039e185d6436e3efc316b0453249db17cbfb714cc105df5e976dc5c7c2bae8c",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-daemon-driver-storage-core-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-log-0__9.5.0-5.el9.aarch64",
    sha256 = "3e20285f46e48e7d5cdff9a6980b5793a12f75d5c9837c7d81f9c742828851d4",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libvirt-daemon-log-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-daemon-log-0__9.5.0-5.el9.x86_64",
    sha256 = "93156858b13db639d629ed45f87491a9c5467bce843b5c5f5e401892ebe431f0",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-daemon-log-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-devel-0__9.5.0-5.el9.aarch64",
    sha256 = "3ef136b93d51988d739689d2324750b0b230fbbf6f678483c905d99a63f8411d",
    urls = [
        "http://mirror.stream.centos.org/9-stream/CRB/aarch64/os/Packages/libvirt-devel-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-devel-0__9.5.0-5.el9.x86_64",
    sha256 = "7239e5b419451f778a083ac738f70f659a146a94e315f4b8d85f8138b27b6508",
    urls = [
        "http://mirror.stream.centos.org/9-stream/CRB/x86_64/os/Packages/libvirt-devel-9.5.0-5.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libvirt-libs-0__9.5.0-5.el9.aarch64",
    sha256 = "99fd45c11d4404fcc00e8d2706a3ca3baada7ef9033e15c15316a3ea69202b14",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/libvirt-libs-9.5.0-5.el9.aarch64.rpm",
    ],
)

rpm(
    name = "libvirt-libs-0__9.5.0-5.el9.x86_64",
    sha256 = "f74d7c9a3ace2b5780771d7eccb10796bbfa2f5454cba86ae97daaca9c00fb10",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/libvirt-libs-9.5.0-5.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-img-17__8.0.0-9.el9.aarch64",
    sha256 = "584cd9a53ebd486dbe3ca7283f741822db9c48089591984c97b752e092b8ab3b",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-img-8.0.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-img-17__8.0.0-9.el9.x86_64",
    sha256 = "68c236cf17fec913214b306d1b4a93d9382b5162cf76dafd50917278323ac146",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-img-8.0.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__8.0.0-9.el9.aarch64",
    sha256 = "bae17c0e35ea2e2fdd637226281c2c9b4020dcdab2a7490aaa7884959c3326b3",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-common-8.0.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-common-17__8.0.0-9.el9.x86_64",
    sha256 = "1f79789d3e8e07870832afae5a2b44af0396de99edf69e30d4cf3b3e746c4e87",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-common-8.0.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__8.0.0-9.el9.aarch64",
    sha256 = "de6857bb5bd51159791ad857cd4c26a713ef57c8d1ad46712bb012ef693e88c2",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-core-8.0.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-core-17__8.0.0-9.el9.x86_64",
    sha256 = "6c363f024e969400c2dc81fbc60e82a8c374c8509ca54086c6ca60a95ce555bd",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-core-8.0.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-17__8.0.0-9.el9.aarch64",
    sha256 = "8b7070158a8b59d2c4e7f5efc1f64eccfaf53cd91c2111cc9660b9ca4e80d04e",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-8.0.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-display-virtio-gpu-pci-17__8.0.0-9.el9.aarch64",
    sha256 = "28e3ff00cbcc3124d65f753dc6ff33d398fd5fa19e55ebea86fa10ec467a26f9",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-kvm-device-display-virtio-gpu-pci-8.0.0-9.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-kvm-device-usb-redirect-17__8.0.0-9.el9.x86_64",
    sha256 = "9c2439849492f719dc875e5125ddb8289a56c2aae1b68658766c75601e3b05da",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-kvm-device-usb-redirect-8.0.0-9.el9.x86_64.rpm",
    ],
)

rpm(
    name = "qemu-pr-helper-17__8.0.0-13.el9.aarch64",
    sha256 = "a5b759bc64b290db7fc86a5dbf0bd9dba6f6402a7967dda8c66513af28c459f8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/aarch64/os/Packages/qemu-pr-helper-8.0.0-13.el9.aarch64.rpm",
    ],
)

rpm(
    name = "qemu-pr-helper-17__8.0.0-13.el9.x86_64",
    sha256 = "1ffd2c416b11674870542fa7530b51fe753f8467ce90e64c2243a088a970541a",
    urls = [
        "http://mirror.stream.centos.org/9-stream/AppStream/x86_64/os/Packages/qemu-pr-helper-8.0.0-13.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "selinux-policy-0__38.1.22-1.el9.aarch64",
    sha256 = "c4ee2c1f4a3324d19642943c2a871c0ab4952b07b255f39a7a4fea74a62e0d82",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/selinux-policy-38.1.22-1.el9.noarch.rpm",
    ],
)
...
rpm(
    name = "selinux-policy-targeted-0__38.1.22-1.el9.aarch64",
    sha256 = "a810056dc595050f52f880ea60138a20d54167bb7095eae6ca317384b4f52d86",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/selinux-policy-targeted-38.1.22-1.el9.noarch.rpm",
    ],
)
...
rpm(
    name = "sssd-client-0__2.9.1-2.el9.aarch64",
    sha256 = "031485bb309b6c18fba1214e4bf54bc1a88fb2609c3902b56ee3ba33217157ce",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/sssd-client-2.9.1-2.el9.aarch64.rpm",
    ],
)

rpm(
    name = "sssd-client-0__2.9.1-2.el9.x86_64",
    sha256 = "c87dac5510921302d11ae83d56e3593f38a7f286d5b64900cfa0a5bfa808a7c8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/sssd-client-2.9.1-2.el9.x86_64.rpm",
    ],
)
