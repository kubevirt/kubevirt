...
rpm(
    name = "glibc-langpack-eo-0__2.39-141.el10.s390x",
    sha256 = "17c654e631daa2d3ca4d9d239f891a401137491dc0877bd03456ea53b47c2faf",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/s390x/os/Packages/glibc-langpack-eo-2.39-141.el10.s390x.rpm",
    ],
)

rpm(
    name = "glibc-langpack-eu-0__2.39-141.el10.aarch64",
    sha256 = "3e897056ec4b334cc78d4f7613e3cc2b0f5effac3eabd97ded75614b17f7a021",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/aarch64/os/Packages/glibc-langpack-eu-2.39-141.el10.aarch64.rpm",
    ],
)
