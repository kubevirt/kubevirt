...
rpm(
    name = "glibc-langpack-aa-0__2.34-231.el9.x86_64",
    sha256 = "b3a25df86f9b74818eb1e020b07a89e7538d0fda9eee0409e7b2dfc5ce6ef2b8",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-langpack-aa-2.34-231.el9.x86_64.rpm",
    ],
)
