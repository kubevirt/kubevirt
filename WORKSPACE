...
http_archive(
    name = "bazeldnf",
    sha256 = "f5da30fb47d8cfc1b35dd8c5cda084f21fc6903a38d3418e1c9ba812cc19338a",
    strip_prefix = "bazeldnf-0.0.11",
    urls = [
        "https://github.com/rmohr/bazeldnf/archive/v0.0.11.tar.gz",
    ],
)
