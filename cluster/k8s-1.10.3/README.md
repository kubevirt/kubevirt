# Kubernetes 1.10.3 in ephemeral containers

Provides a pre-deployed Kubernetes with version 1.10.3 purely in docker
...
node01    NotReady   master    31s       v1.10.3
node02    NotReady   <none>    5s        v1.10.3
```
