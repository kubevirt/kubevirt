...
_cli="docker run --privileged --rm ${USE_TTY} -v /var/run/docker.sock:/var/run/docker.sock kubevirtci/gocli@sha256:2d532e52ceb26a7406f963381b0cbc1ec7573fb31d7fda622bca18bdb40399c7"
