...
if [ -z $KUBEVIRTCI_PROVISION_CHECK ]; then
    IMAGES[k8s-fedora-1.17.0]="k8s-fedora-1.17.0@sha256:f08b58384bc8265049f96874d56be1ca12fd1ed60f217d5586a0859d02455d84"
    IMAGES[k8s-1.17.0]="k8s-1.17.0@sha256:e81eeb46721b79b9cc21c9885d18b0261486aa83a19425bd5d5bef31052dc017"
