...
// TODO rename
var justAfterEachReporter = []ginkgo_reporters.DeprecatedReporter{}
...
func KubeVirtTestSuiteSetup(t *testing.T) {
	...
	if testsWrapped == "0" && outputFile != "" {
		...
		justAfterEachReporter = append(justAfterEachReporter, v1reporter.NewV1JUnitReporter(outputFile))
