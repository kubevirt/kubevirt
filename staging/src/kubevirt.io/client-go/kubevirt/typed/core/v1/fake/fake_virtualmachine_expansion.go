...
func (c *FakeVirtualMachines) ObjectGraph(ctx context.Context, name string) (v1.ObjectGraphNodeList, error) {
	obj, err := c.Fake.
		Invokes(fake2.NewPutSubresourceAction(virtualmachinesResource, c.ns, "objectgraph", name, struct{}{}), nil)

	return *obj.(*v1.ObjectGraphNodeList), err
}
