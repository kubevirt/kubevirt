...
type VirtualMachineInstanceExpansion interface {
	...
	ObjectGraph(ctx context.Context, name string) (v1.ObjectGraphNodeList, error)
...
func (c *virtualMachineInstances) ObjectGraph(ctx context.Context, name string) (v1.ObjectGraphNodeList, error) {
