...
import (
	...
	v1alpha3 "kubevirt.io/client-go/generated/kubevirt/clientset/versioned/typed/instancetype/v1alpha3"
...
func (_m *MockKubevirtClient) VirtualMachineInstancetype(namespace string) v1alpha3.VirtualMachineInstancetypeInterface {
	ret := _m.ctrl.Call(_m, "VirtualMachineInstancetype", namespace)
	ret0, _ := ret[0].(v1alpha3.VirtualMachineInstancetypeInterface)
	return ret0
}
...
func (_m *MockKubevirtClient) VirtualMachineClusterInstancetype() v1alpha3.VirtualMachineClusterInstancetypeInterface {
	ret := _m.ctrl.Call(_m, "VirtualMachineClusterInstancetype")
	ret0, _ := ret[0].(v1alpha3.VirtualMachineClusterInstancetypeInterface)
	return ret0
}
...
func (_m *MockKubevirtClient) VirtualMachinePreference(namespace string) v1alpha3.VirtualMachinePreferenceInterface {
	ret := _m.ctrl.Call(_m, "VirtualMachinePreference", namespace)
	ret0, _ := ret[0].(v1alpha3.VirtualMachinePreferenceInterface)
	return ret0
}
...
func (_m *MockKubevirtClient) VirtualMachineClusterPreference() v1alpha3.VirtualMachineClusterPreferenceInterface {
	ret := _m.ctrl.Call(_m, "VirtualMachineClusterPreference")
	ret0, _ := ret[0].(v1alpha3.VirtualMachineClusterPreferenceInterface)
	return ret0
}
