...
import (
	...
	v1alpha19 "kubevirt.io/api/backup/v1alpha1"
	...
	v1alpha110 "kubevirt.io/client-go/kubevirt/typed/backup/v1alpha1"
...
func (m *MockKubevirtClient) ResourceV1beta2() v1beta21.ResourceV1beta2Interface {
	m.ctrl.T.Helper()
...
func (m *MockKubevirtClient) VirtualMachineBackup(namespace string) v1alpha110.VirtualMachineBackupInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VirtualMachineBackup", namespace)
	ret0, _ := ret[0].(v1alpha110.VirtualMachineBackupInterface)
	return ret0
}
...
func (m *MockVirtualMachineInstanceInterface) Backup(ctx context.Context, name string, backupOptions *v1alpha19.BackupOptions) error {
	m.ctrl.T.Helper()
