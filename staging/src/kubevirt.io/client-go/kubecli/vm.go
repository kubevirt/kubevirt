...
func (v *vm) AddInterface(name string, addInterfaceOptions *v1.AddInterfaceOptions) error {
...
func (v *vm) RemoveInterface(name string, removeInterfaceOptions *v1.RemoveInterfaceOptions) error {
