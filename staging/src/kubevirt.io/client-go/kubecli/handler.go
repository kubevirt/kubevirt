...
type VirtHandlerConn interface {
	...
	VNCURI(vmi *virtv1.VirtualMachineInstance, force bool) (string, error)
...
func (v *virtHandlerConn) VNCURI(vmi *virtv1.VirtualMachineInstance, force bool) (string, error) {
