...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineFlavorCustomProfile) DeepCopyInto(out *VirtualMachineFlavorCustomProfile) {
	*out = *in
	in.Profile.DeepCopyInto(&out.Profile)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineFlavorCustomProfile.
func (in *VirtualMachineFlavorCustomProfile) DeepCopy() *VirtualMachineFlavorCustomProfile {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineFlavorCustomProfile)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineFlavorSpec) DeepCopyInto(out *VirtualMachineFlavorSpec) {
	*out = *in
	in.DefaultProfile.DeepCopyInto(&out.DefaultProfile)
	if in.CustomProfiles != nil {
		in, out := &in.CustomProfiles, &out.CustomProfiles
		*out = make([]VirtualMachineFlavorCustomProfile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
