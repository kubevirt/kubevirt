...
var virtualmachineclusterpreferencesResource = schema.GroupVersionResource{Group: "instancetype.kubevirt.io", Version: "v1alpha2", Resource: "virtualmachineclusterpreferences"}

var virtualmachineclusterpreferencesKind = schema.GroupVersionKind{Group: "instancetype.kubevirt.io", Version: "v1alpha2", Kind: "VirtualMachineClusterPreference"}
...
func (c *FakeVirtualMachineClusterPreferences) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineClusterPreference, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(virtualmachineclusterpreferencesResource, name), &v1alpha2.VirtualMachineClusterPreference{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVirtualMachineClusterPreferences) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineClusterPreferenceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(virtualmachineclusterpreferencesResource, virtualmachineclusterpreferencesKind, opts), &v1alpha2.VirtualMachineClusterPreferenceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVirtualMachineClusterPreferences) Create(ctx context.Context, virtualMachineClusterPreference *v1alpha2.VirtualMachineClusterPreference, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineClusterPreference, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(virtualmachineclusterpreferencesResource, virtualMachineClusterPreference), &v1alpha2.VirtualMachineClusterPreference{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.VirtualMachineClusterPreference), err
...
func (c *FakeVirtualMachineClusterPreferences) Update(ctx context.Context, virtualMachineClusterPreference *v1alpha2.VirtualMachineClusterPreference, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineClusterPreference, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(virtualmachineclusterpreferencesResource, virtualMachineClusterPreference), &v1alpha2.VirtualMachineClusterPreference{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.VirtualMachineClusterPreference), err
...
func (c *FakeVirtualMachineClusterPreferences) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineClusterPreference, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(virtualmachineclusterpreferencesResource, name, pt, data, subresources...), &v1alpha2.VirtualMachineClusterPreference{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.VirtualMachineClusterPreference), err
