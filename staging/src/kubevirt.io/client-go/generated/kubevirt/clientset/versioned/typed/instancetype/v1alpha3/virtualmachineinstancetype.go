...
type VirtualMachineInstancetypeInterface interface {
	Create(ctx context.Context, virtualMachineInstancetype *v1alpha3.VirtualMachineInstancetype, opts v1.CreateOptions) (*v1alpha3.VirtualMachineInstancetype, error)
	Update(ctx context.Context, virtualMachineInstancetype *v1alpha3.VirtualMachineInstancetype, opts v1.UpdateOptions) (*v1alpha3.VirtualMachineInstancetype, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.VirtualMachineInstancetype, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.VirtualMachineInstancetypeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.VirtualMachineInstancetype, err error)
...
func newVirtualMachineInstancetypes(c *InstancetypeV1alpha3Client, namespace string) *virtualMachineInstancetypes {
...
func (c *virtualMachineInstancetypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.VirtualMachineInstancetype, err error) {
	result = &v1alpha3.VirtualMachineInstancetype{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *virtualMachineInstancetypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.VirtualMachineInstancetypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.VirtualMachineInstancetypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("virtualmachineinstancetypes").
...
func (c *virtualMachineInstancetypes) Create(ctx context.Context, virtualMachineInstancetype *v1alpha3.VirtualMachineInstancetype, opts v1.CreateOptions) (result *v1alpha3.VirtualMachineInstancetype, err error) {
	result = &v1alpha3.VirtualMachineInstancetype{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachineinstancetypes").
...
func (c *virtualMachineInstancetypes) Update(ctx context.Context, virtualMachineInstancetype *v1alpha3.VirtualMachineInstancetype, opts v1.UpdateOptions) (result *v1alpha3.VirtualMachineInstancetype, err error) {
	result = &v1alpha3.VirtualMachineInstancetype{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachineinstancetypes").
...
func (c *virtualMachineInstancetypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.VirtualMachineInstancetype, err error) {
	result = &v1alpha3.VirtualMachineInstancetype{}
