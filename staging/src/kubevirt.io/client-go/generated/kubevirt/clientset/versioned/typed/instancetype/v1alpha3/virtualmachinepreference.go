...
type VirtualMachinePreferenceInterface interface {
	Create(ctx context.Context, virtualMachinePreference *v1alpha3.VirtualMachinePreference, opts v1.CreateOptions) (*v1alpha3.VirtualMachinePreference, error)
	Update(ctx context.Context, virtualMachinePreference *v1alpha3.VirtualMachinePreference, opts v1.UpdateOptions) (*v1alpha3.VirtualMachinePreference, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.VirtualMachinePreference, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.VirtualMachinePreferenceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.VirtualMachinePreference, err error)
...
func newVirtualMachinePreferences(c *InstancetypeV1alpha3Client, namespace string) *virtualMachinePreferences {
...
func (c *virtualMachinePreferences) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.VirtualMachinePreference, err error) {
	result = &v1alpha3.VirtualMachinePreference{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *virtualMachinePreferences) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.VirtualMachinePreferenceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.VirtualMachinePreferenceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("virtualmachinepreferences").
...
func (c *virtualMachinePreferences) Create(ctx context.Context, virtualMachinePreference *v1alpha3.VirtualMachinePreference, opts v1.CreateOptions) (result *v1alpha3.VirtualMachinePreference, err error) {
	result = &v1alpha3.VirtualMachinePreference{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachinepreferences").
...
func (c *virtualMachinePreferences) Update(ctx context.Context, virtualMachinePreference *v1alpha3.VirtualMachinePreference, opts v1.UpdateOptions) (result *v1alpha3.VirtualMachinePreference, err error) {
	result = &v1alpha3.VirtualMachinePreference{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachinepreferences").
...
func (c *virtualMachinePreferences) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.VirtualMachinePreference, err error) {
	result = &v1alpha3.VirtualMachinePreference{}
