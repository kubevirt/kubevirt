...
func (c *virtualMachineClusterInstancetypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineClusterInstancetype, err error) {
	result = &v1alpha2.VirtualMachineClusterInstancetype{}
	err = c.client.Get().
...
func (c *virtualMachineClusterInstancetypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineClusterInstancetypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.VirtualMachineClusterInstancetypeList{}
	err = c.client.Get().
		Resource("virtualmachineclusterinstancetypes").
...
func (c *virtualMachineClusterInstancetypes) Create(ctx context.Context, virtualMachineClusterInstancetype *v1alpha2.VirtualMachineClusterInstancetype, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineClusterInstancetype, err error) {
	result = &v1alpha2.VirtualMachineClusterInstancetype{}
	err = c.client.Post().
		Resource("virtualmachineclusterinstancetypes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *virtualMachineClusterInstancetypes) Update(ctx context.Context, virtualMachineClusterInstancetype *v1alpha2.VirtualMachineClusterInstancetype, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineClusterInstancetype, err error) {
	result = &v1alpha2.VirtualMachineClusterInstancetype{}
	err = c.client.Put().
		Resource("virtualmachineclusterinstancetypes").
...
func (c *virtualMachineClusterInstancetypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineClusterInstancetype, err error) {
	result = &v1alpha2.VirtualMachineClusterInstancetype{}
