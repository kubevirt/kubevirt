...
type CDIInterface interface {
	...
	Get(name string, options v1.GetOptions) (*v1beta1.CDI, error)
	List(opts v1.ListOptions) (*v1beta1.CDIList, error)
...
func (c *cDIs) Get(name string, options v1.GetOptions) (result *v1beta1.CDI, err error) {
	result = &v1beta1.CDI{}
	err = c.client.Get().
		Resource("cdis").
		Name(name).
...
func (c *cDIs) List(opts v1.ListOptions) (result *v1beta1.CDIList, err error) {
...
func (c *cDIs) Create(cDI *v1beta1.CDI) (result *v1beta1.CDI, err error) {
	result = &v1beta1.CDI{}
	err = c.client.Post().
		Resource("cdis").
		Body(cDI).
...
func (c *cDIs) Update(cDI *v1beta1.CDI) (result *v1beta1.CDI, err error) {
	result = &v1beta1.CDI{}
	err = c.client.Put().
		Resource("cdis").
		Name(cDI.Name).
...
func (c *cDIs) UpdateStatus(cDI *v1beta1.CDI) (result *v1beta1.CDI, err error) {
	result = &v1beta1.CDI{}
	err = c.client.Put().
		Resource("cdis").
		Name(cDI.Name).
...
func (c *cDIs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CDI, err error) {
	result = &v1beta1.CDI{}
