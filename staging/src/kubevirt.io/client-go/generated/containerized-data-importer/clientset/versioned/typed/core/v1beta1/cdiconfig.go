...
type CDIConfigInterface interface {
	...
	Get(name string, options v1.GetOptions) (*v1beta1.CDIConfig, error)
	List(opts v1.ListOptions) (*v1beta1.CDIConfigList, error)
...
func (c *cDIConfigs) Get(name string, options v1.GetOptions) (result *v1beta1.CDIConfig, err error) {
...
func (c *cDIConfigs) List(opts v1.ListOptions) (result *v1beta1.CDIConfigList, err error) {
...
func (c *cDIConfigs) Create(cDIConfig *v1beta1.CDIConfig) (result *v1beta1.CDIConfig, err error) {
	result = &v1beta1.CDIConfig{}
	err = c.client.Post().
		Resource("cdiconfigs").
		Body(cDIConfig).
...
func (c *cDIConfigs) Update(cDIConfig *v1beta1.CDIConfig) (result *v1beta1.CDIConfig, err error) {
	result = &v1beta1.CDIConfig{}
	err = c.client.Put().
		Resource("cdiconfigs").
		Name(cDIConfig.Name).
...
func (c *cDIConfigs) UpdateStatus(cDIConfig *v1beta1.CDIConfig) (result *v1beta1.CDIConfig, err error) {
	result = &v1beta1.CDIConfig{}
	err = c.client.Put().
		Resource("cdiconfigs").
		Name(cDIConfig.Name).
...
func (c *cDIConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CDIConfig, err error) {
	result = &v1beta1.CDIConfig{}
