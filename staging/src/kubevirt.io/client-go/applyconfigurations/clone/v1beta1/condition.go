...
type ConditionApplyConfiguration struct {
	Type               *clonev1beta1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value clonev1beta1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
