...
type ConditionApplyConfiguration struct {
	Type               *clonev1alpha1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value clonev1alpha1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
