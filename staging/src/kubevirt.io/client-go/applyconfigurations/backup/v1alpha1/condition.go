...
type ConditionApplyConfiguration struct {
	Type               *backupv1alpha1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value backupv1alpha1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
