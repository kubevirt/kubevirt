...
type ConditionApplyConfiguration struct {
	Type               *snapshotv1beta1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value snapshotv1beta1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
