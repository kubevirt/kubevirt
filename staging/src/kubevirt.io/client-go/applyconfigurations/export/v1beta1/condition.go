...
type ConditionApplyConfiguration struct {
	Type               *exportv1beta1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value exportv1beta1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
