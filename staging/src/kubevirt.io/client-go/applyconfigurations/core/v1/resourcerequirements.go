...
// WithOvercommitGuestOverhead sets the OvercommitGuestOverhead field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the OvercommitGuestOverhead field is set to the value of the last call.
func (b *ResourceRequirementsApplyConfiguration) WithOvercommitGuestOverhead(value bool) *ResourceRequirementsApplyConfiguration {
	b.OvercommitGuestOverhead = &value
	return b
}
