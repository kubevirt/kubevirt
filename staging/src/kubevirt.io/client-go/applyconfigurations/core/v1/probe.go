...
func (b *ProbeApplyConfiguration) WithExec(value corev1.ExecAction) *ProbeApplyConfiguration {
	b.HandlerApplyConfiguration.Exec = &value
	return b
}
...
func (b *ProbeApplyConfiguration) WithGuestAgentPing(value apicorev1.GuestAgentPing) *ProbeApplyConfiguration {
	b.HandlerApplyConfiguration.GuestAgentPing = &value
	return b
}
...
func (b *ProbeApplyConfiguration) WithHTTPGet(value corev1.HTTPGetAction) *ProbeApplyConfiguration {
	b.HandlerApplyConfiguration.HTTPGet = &value
	return b
}
...
func (b *ProbeApplyConfiguration) WithTCPSocket(value corev1.TCPSocketAction) *ProbeApplyConfiguration {
	b.HandlerApplyConfiguration.TCPSocket = &value
	return b
}
