...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterProfilerOptions) DeepCopyInto(out *ClusterProfilerOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterProfilerOptions.
func (in *ClusterProfilerOptions) DeepCopy() *ClusterProfilerOptions {
	if in == nil {
		return nil
	}
	out := new(ClusterProfilerOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProfilerResult) DeepCopyInto(out *ProfilerResult) {
	*out = *in
	...
	if in.HTTPRequestCounts != nil {
		in, out := &in.HTTPRequestCounts, &out.HTTPRequestCounts
