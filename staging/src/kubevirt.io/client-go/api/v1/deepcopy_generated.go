...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigDriveAccessCredentialPropagation) DeepCopyInto(out *ConfigDriveAccessCredentialPropagation) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigDriveAccessCredentialPropagation.
func (in *ConfigDriveAccessCredentialPropagation) DeepCopy() *ConfigDriveAccessCredentialPropagation {
	if in == nil {
		return nil
	}
	out := new(ConfigDriveAccessCredentialPropagation)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QemuGuestAgentAccessCredentialPropagation) DeepCopyInto(out *QemuGuestAgentAccessCredentialPropagation) {
	*out = *in
	if in.AuthorizedKeysFiles != nil {
		in, out := &in.AuthorizedKeysFiles, &out.AuthorizedKeysFiles
		*out = make([]AuthorizedKeysFile, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QemuGuestAgentAccessCredentialPropagation.
func (in *QemuGuestAgentAccessCredentialPropagation) DeepCopy() *QemuGuestAgentAccessCredentialPropagation {
	if in == nil {
		return nil
	}
	out := new(QemuGuestAgentAccessCredentialPropagation)
	in.DeepCopyInto(out)
	return out
}
