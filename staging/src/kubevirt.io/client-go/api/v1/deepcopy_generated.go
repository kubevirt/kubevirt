...
func (in *KubeVirtSpec) DeepCopyInto(out *KubeVirtSpec) {
	*out = *in
	if in.VirtAPIMemory != nil {
		in, out := &in.VirtAPIMemory, &out.VirtAPIMemory
		if *in == nil {
			*out = nil
		} else {
			x := (*in).DeepCopy()
	...
	if in.VirtAPICPU != nil {
		in, out := &in.VirtAPICPU, &out.VirtAPICPU
		if *in == nil {
			*out = nil
		} else {
			x := (*in).DeepCopy()
	...
	if in.VirtControllerMemory != nil {
		in, out := &in.VirtControllerMemory, &out.VirtControllerMemory
		if *in == nil {
			*out = nil
		} else {
			x := (*in).DeepCopy()
	...
	if in.VirtControllerCPU != nil {
		in, out := &in.VirtControllerCPU, &out.VirtControllerCPU
		if *in == nil {
			*out = nil
		} else {
			x := (*in).DeepCopy()
