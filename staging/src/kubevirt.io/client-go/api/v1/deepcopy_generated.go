...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeveloperConfigurations) DeepCopyInto(out *DeveloperConfigurations) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeveloperConfigurations.
func (in *DeveloperConfigurations) DeepCopy() *DeveloperConfigurations {
	if in == nil {
		return nil
	}
	out := new(DeveloperConfigurations)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeVirtSpec) DeepCopyInto(out *KubeVirtSpec) {
	*out = *in
	in.KubevirtConfigurations.DeepCopyInto(&out.KubevirtConfigurations)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubevirtConfigurations) DeepCopyInto(out *KubevirtConfigurations) {
	*out = *in
	...
	if in.SMBIOSConfig != nil {
		...
		*out = new(cmdv1.SMBios)
		**out = **in
	}
	if in.NetworkConfigurations != nil {
		in, out := &in.NetworkConfigurations, &out.NetworkConfigurations
		*out = new(NetworkConfigurations)
		**out = **in
	}
	if in.DeveloperConfigurations != nil {
		in, out := &in.DeveloperConfigurations, &out.DeveloperConfigurations
		*out = new(DeveloperConfigurations)
		(*in).DeepCopyInto(*out)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubevirtConfigurations.
func (in *KubevirtConfigurations) DeepCopy() *KubevirtConfigurations {
	if in == nil {
		return nil
	}
	out := new(KubevirtConfigurations)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkConfigurations) DeepCopyInto(out *NetworkConfigurations) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkConfigurations.
func (in *NetworkConfigurations) DeepCopy() *NetworkConfigurations {
	if in == nil {
		return nil
	}
	out := new(NetworkConfigurations)
