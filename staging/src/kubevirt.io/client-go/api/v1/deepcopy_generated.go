...
func (in *MigrationConfiguration) DeepCopyInto(out *MigrationConfiguration) {
	*out = *in
	...
	if in.PerVMIMigrationConfiguration != nil {
		in, out := &in.PerVMIMigrationConfiguration, &out.PerVMIMigrationConfiguration
		*out = new(PerVMIMigrationConfiguration)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerVMIMigrationConfiguration) DeepCopyInto(out *PerVMIMigrationConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerVMIMigrationConfiguration.
func (in *PerVMIMigrationConfiguration) DeepCopy() *PerVMIMigrationConfiguration {
	if in == nil {
		return nil
	}
	out := new(PerVMIMigrationConfiguration)
