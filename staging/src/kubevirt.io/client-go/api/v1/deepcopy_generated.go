...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in VirtualMachineInstanceIsoSizes) DeepCopyInto(out *VirtualMachineInstanceIsoSizes) {
	{
		in := &in
		*out = make(VirtualMachineInstanceIsoSizes, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineInstanceIsoSizes.
func (in VirtualMachineInstanceIsoSizes) DeepCopy() VirtualMachineInstanceIsoSizes {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineInstanceIsoSizes)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *VirtualMachineInstanceStatus) DeepCopyInto(out *VirtualMachineInstanceStatus) {
	*out = *in
	...
	if in.IsoSizes != nil {
		in, out := &in.IsoSizes, &out.IsoSizes
		*out = make(VirtualMachineInstanceIsoSizes, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
