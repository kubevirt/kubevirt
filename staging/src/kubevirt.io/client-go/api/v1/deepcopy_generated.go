...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in VirtualMachineInstanceCloudInitSizes) DeepCopyInto(out *VirtualMachineInstanceCloudInitSizes) {
	{
		in := &in
		*out = make(VirtualMachineInstanceCloudInitSizes, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineInstanceCloudInitSizes.
func (in VirtualMachineInstanceCloudInitSizes) DeepCopy() VirtualMachineInstanceCloudInitSizes {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineInstanceCloudInitSizes)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *VirtualMachineInstanceStatus) DeepCopyInto(out *VirtualMachineInstanceStatus) {
	*out = *in
	...
	if in.CloudInitSizes != nil {
		in, out := &in.CloudInitSizes, &out.CloudInitSizes
		*out = make(VirtualMachineInstanceCloudInitSizes, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
