...
func (in *Devices) DeepCopyInto(out *Devices) {
	*out = *in
	...
	if in.Sounds != nil {
		in, out := &in.Sounds, &out.Sounds
		*out = make([]Sound, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Sound) DeepCopyInto(out *Sound) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Sound device.
func (in *Sound) DeepCopy() *Sound {
	if in == nil {
		return nil
	}
	out := new(Sound)
