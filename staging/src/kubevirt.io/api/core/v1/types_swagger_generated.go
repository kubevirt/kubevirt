...
func (VirtualMachineInstanceSpec) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"flavor":                        "FlavorMatcher references a flavor that is used to fill fields in DomainSpec\n+optional",
		"preference":                    "PreferenceMatcher references a set of preference that is used to fill fields in DomainSpec\n+optional",
	}
}
