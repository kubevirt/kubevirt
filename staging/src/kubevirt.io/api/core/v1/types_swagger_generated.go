...
func (KubeVirtSpec) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"kubeletRootHostPath":          "The host path of virt-handler's kubelet-root volume to use\n+optional",
		"kubeletPodsHostPath":          "The host path of virt-handler's kubelet-pods volume to use\n+optional",
		"kubeletDevicePluginsHostPath": "The host path of virt-handler's kubelet-device-plugins volume to use\n+optional",
	}
}
