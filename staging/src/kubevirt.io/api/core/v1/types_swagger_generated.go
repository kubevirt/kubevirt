...
func (KubeVirtConfiguration) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"multiIOThreadAutoPolicy":            "MultiIOThreadAutoPolicy controls the behavior for auto IOThread Policy for virtio-blk devices.\n+nullable",
...
func (MultiIOThreadAutoPolicy) SwaggerDoc() map[string]string {
	return map[string]string{
		"enabled": "Enables the auto IOThread Policy to use multiple iothreads for virtio-blk devices.\n+nullable",
	}
}
