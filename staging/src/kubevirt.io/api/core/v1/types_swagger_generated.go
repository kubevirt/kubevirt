...
func (KubeVirtConfiguration) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"vmStateAccessMode":                  "VMStateAccessMode is the name of the persistent volume access mode to use for the PVCs created to preserve VM state.  The default is ReadWriteMany.",
