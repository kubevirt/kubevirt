...
func (MigrationPolicyOptions) SwaggerDoc() map[string]string {
	return map[string]string{
...
func (MigrationPolicyOverridableFields) SwaggerDoc() map[string]string {
	return map[string]string{
...
func (MigrationPolicyNonOverridableFields) SwaggerDoc() map[string]string {
	return map[string]string{
