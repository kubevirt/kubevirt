...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdditionalVirtHandlerConfig) DeepCopyInto(out *AdditionalVirtHandlerConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalVirtHandlerConfig.
func (in *AdditionalVirtHandlerConfig) DeepCopy() *AdditionalVirtHandlerConfig {
	if in == nil {
		return nil
	}
	out := new(AdditionalVirtHandlerConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeVirtSpec) DeepCopyInto(out *KubeVirtSpec) {
	*out = *in
	...
	if in.AdditionalVirtHandlers != nil {
		in, out := &in.AdditionalVirtHandlers, &out.AdditionalVirtHandlers
		*out = make([]AdditionalVirtHandlerConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
