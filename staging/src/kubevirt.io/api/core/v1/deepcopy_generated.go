...
func (in *VirtualMachineInstanceMigrationSourceState) DeepCopyInto(out *VirtualMachineInstanceMigrationSourceState) {
	*out = *in
	...
	if in.SynchronizationConnectionURL != nil {
		in, out := &in.SynchronizationConnectionURL, &out.SynchronizationConnectionURL
		*out = new(string)
		**out = **in
	}
	return
...
func (in *VirtualMachineInstanceMigrationTargetState) DeepCopyInto(out *VirtualMachineInstanceMigrationTargetState) {
	*out = *in
	if in.NodeDomainReadyTimestamp != nil {
		in, out := &in.NodeDomainReadyTimestamp, &out.NodeDomainReadyTimestamp
		*out = (*in).DeepCopy()
	}
