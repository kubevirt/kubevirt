...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileBacked) DeepCopyInto(out *FileBacked) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileBacked.
func (in *FileBacked) DeepCopy() *FileBacked {
	if in == nil {
		return nil
	}
	out := new(FileBacked)
...
func (in *Memory) DeepCopyInto(out *Memory) {
	*out = *in
	...
	if in.FileBacked != nil {
		in, out := &in.FileBacked, &out.FileBacked
		*out = new(FileBacked)
		**out = **in
	}
	return
