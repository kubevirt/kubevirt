...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in OemStringList) DeepCopyInto(out *OemStringList) {
	{
		in := &in
		*out = make(OemStringList, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OemStringList.
func (in OemStringList) DeepCopy() OemStringList {
	if in == nil {
		return nil
	}
	out := new(OemStringList)
	in.DeepCopyInto(out)
	return *out
}
