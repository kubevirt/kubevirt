...
func (in *KubeVirtConfiguration) DeepCopyInto(out *KubeVirtConfiguration) {
	*out = *in
	...
	if in.MultiIOThreadAutoPolicy != nil {
		in, out := &in.MultiIOThreadAutoPolicy, &out.MultiIOThreadAutoPolicy
		*out = new(MultiIOThreadAutoPolicy)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiIOThreadAutoPolicy) DeepCopyInto(out *MultiIOThreadAutoPolicy) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiIOThreadAutoPolicy.
func (in *MultiIOThreadAutoPolicy) DeepCopy() *MultiIOThreadAutoPolicy {
	if in == nil {
		return nil
	}
	out := new(MultiIOThreadAutoPolicy)
