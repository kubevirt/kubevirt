...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceClaimSource) DeepCopyInto(out *ResourceClaimSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceClaimSource.
func (in *ResourceClaimSource) DeepCopy() *ResourceClaimSource {
	if in == nil {
		return nil
	}
	out := new(ResourceClaimSource)
	in.DeepCopyInto(out)
	return out
}
