...
func (in *InterfaceBindingPlugin) DeepCopyInto(out *InterfaceBindingPlugin) {
	*out = *in
	...
	if in.MemoryLockLimits != nil {
		in, out := &in.MemoryLockLimits, &out.MemoryLockLimits
		*out = new(MemoryLockLimitRequirements)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryLockLimitRequirements) DeepCopyInto(out *MemoryLockLimitRequirements) {
	*out = *in
	if in.Offset != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryLockLimitRequirements.
func (in *MemoryLockLimitRequirements) DeepCopy() *MemoryLockLimitRequirements {
	if in == nil {
		return nil
	}
	out := new(MemoryLockLimitRequirements)
