...
func (in *ServiceStatus) DeepCopyInto(out *ServiceStatus) {
	*out = *in
	if in.VNCStatuses != nil {
		in, out := &in.VNCStatuses, &out.VNCStatuses
		*out = make([]*VNCStatusInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VNCStatusInfo)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VNCStatusInfo) DeepCopyInto(out *VNCStatusInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VNCStatusInfo.
func (in *VNCStatusInfo) DeepCopy() *VNCStatusInfo {
	if in == nil {
		return nil
	}
	out := new(VNCStatusInfo)
