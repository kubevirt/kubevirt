...
func (in *KubeVirtConfiguration) DeepCopyInto(out *KubeVirtConfiguration) {
	*out = *in
	...
	if in.SupportPodTolerations != nil {
		in, out := &in.SupportPodTolerations, &out.SupportPodTolerations
		*out = make([]SupportPodTolerations, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SupportPodTolerations) DeepCopyInto(out *SupportPodTolerations) {
	*out = *in
	if in.Tolerations != nil {
		in, out := &in.Tolerations, &out.Tolerations
		*out = make([]corev1.Toleration, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SupportPodTolerations.
func (in *SupportPodTolerations) DeepCopy() *SupportPodTolerations {
	if in == nil {
		return nil
	}
	out := new(SupportPodTolerations)
	in.DeepCopyInto(out)
	return out
}
