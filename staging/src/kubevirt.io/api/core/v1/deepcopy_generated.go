...
func (in *VirtualMachineStatus) DeepCopyInto(out *VirtualMachineStatus) {
	*out = *in
	...
	if in.StatusTransitionTimestamps != nil {
		in, out := &in.StatusTransitionTimestamps, &out.StatusTransitionTimestamps
		*out = make([]VirtualMachineStatusTransitionTimestamp, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineStatusTransitionTimestamp) DeepCopyInto(out *VirtualMachineStatusTransitionTimestamp) {
	*out = *in
	in.StatusTransitionTimestamp.DeepCopyInto(&out.StatusTransitionTimestamp)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineStatusTransitionTimestamp.
func (in *VirtualMachineStatusTransitionTimestamp) DeepCopy() *VirtualMachineStatusTransitionTimestamp {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineStatusTransitionTimestamp)
	in.DeepCopyInto(out)
	return out
}
