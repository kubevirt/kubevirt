...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IOMMUDeviceDriver) DeepCopyInto(out *IOMMUDeviceDriver) {
	*out = *in
	if in.PCIBus != nil {
		in, out := &in.PCIBus, &out.PCIBus
		*out = new(uint)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IOMMUDeviceDriver.
func (in *IOMMUDeviceDriver) DeepCopy() *IOMMUDeviceDriver {
	if in == nil {
		return nil
	}
	out := new(IOMMUDeviceDriver)
