...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SourceIndications) DeepCopyInto(out *SourceIndications) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SourceIndications.
func (in *SourceIndications) DeepCopy() *SourceIndications {
	if in == nil {
		return nil
	}
	out := new(SourceIndications)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineSnapshotStatus) DeepCopyInto(out *VirtualMachineSnapshotStatus) {
	*out = *in
	...
	if in.SourceIndications != nil {
		...
		*out = make([]SourceIndications, len(*in))
		copy(*out, *in)
	}
