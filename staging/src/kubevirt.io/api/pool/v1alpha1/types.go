...
const (
	...
	VirtualMachinePoolSortPolicyRandom          VirtualMachinePoolSortPolicy = "RandomPolicy"
)
...
type VirtualMachinePoolSelectionPolicy struct {
	// SortPolicy is a catch-all policy [AscendingOrder|DescendingOrder|Newest|Oldest|RandomPolicy]
	// +optional
