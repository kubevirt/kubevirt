...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineCloneSpecTemplate) DeepCopyInto(out *VirtualMachineCloneSpecTemplate) {
	*out = *in
	if in.AnnotationFilters != nil {
		in, out := &in.AnnotationFilters, &out.AnnotationFilters
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineCloneSpecTemplate.
func (in *VirtualMachineCloneSpecTemplate) DeepCopy() *VirtualMachineCloneSpecTemplate {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineCloneSpecTemplate)
	in.DeepCopyInto(out)
	return out
}
