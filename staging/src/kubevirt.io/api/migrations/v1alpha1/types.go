...
func (m *MigrationPolicy) ApplyMigrationPolicy(dst *k6tv1.VMIMConfigurationOptions, src *k6tv1.MigrationPolicyOptions) {
	...
	_ = json.Unmarshal(srcJSON, &dst.MigrationPolicyOptions)
}
