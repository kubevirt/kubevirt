...
func init() {
	...
	flag.StringVar(&VMImage, "vmi-img", "cirros", "vmi image name")
	...
	flag.DurationVar(&MaxWaitTimeout, "max-wait-timeout", 5*time.Minute, "maximum wait period")
	flag.Float64Var(&QPS, "qps", 0, "number of queries per second for VMI creation")
	flag.IntVar(&Burst, "burst", 0, "maximum burst for throttle the VMI creation")
